...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t3543 = (*lv);
        if (_t3543.tag == MacroVal_MInt) {
            __auto_type a = _t3543.data.MInt.n;
            /* pass */
            __auto_type _t3544 = (*rv);
            if (_t3544.tag == MacroVal_MInt) {
                __auto_type b = _t3544.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t3544;
                return ({ TrStr _at_t3545 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3545))); _tr_str_release(_at_t3545); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t3543;
            return ({ TrStr _at_t3546 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3546))); _tr_str_release(_at_t3546); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    __auto_type _t3547 = (*lv);
    if (_t3547.tag == MacroVal_MInt) {
        __auto_type a = _t3547.data.MInt.n;
        /* pass */
        __auto_type _t3548 = (*rv);
        if (_t3548.tag == MacroVal_MInt) {
            __auto_type b = _t3548.data.MInt.n;
            /* pass */
            if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("<"))) == 0)) {
                /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3549 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3549); _tr_str_release(_at_t3549); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3550 = (*eptr);
    if (_t3550.tag == Expr_ELitStr) {
        __auto_type s = _t3550.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3550.tag == Expr_ERawStr) {
        __auto_type s = _t3550.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3550.tag == Expr_ELitInt) {
        __auto_type n = _t3550.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t3550.tag == Expr_ELitBool) {
        __auto_type b = _t3550.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t3550.tag == Expr_EIdent) {
        ...
        /* pass */
        ({ TrStr _at_t3551 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3551); _tr_str_release(_at_t3551); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3550.tag == Expr_EBinOp) {
        __auto_type op = _t3550.data.EBinOp.op;
__auto_type l = _t3550.data.EBinOp.left;
__auto_type r = _t3550.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t3550.tag == Expr_EUnaryOp) {
        __auto_type op = _t3550.data.EUnaryOp.op;
__auto_type x = _t3550.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t3552 = (*xv);
            if (_t3552.tag == MacroVal_MInt) {
                __auto_type n = _t3552.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t3553 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3553); _tr_str_release(_at_t3553); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3550.tag == Expr_EFString) {
        __auto_type parts = _t3550.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t3554 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t3554;
            } else {
                /* pass */
                TrStr _strtmp_t3555 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t3555;
            }
            /* pass */
    ...
    } else if (_t3550.tag == Expr_EIndex) {
        __auto_type obj = _t3550.data.EIndex.obj;
__auto_type idx = _t3550.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t3556 = (*ov);
        if (_t3556.tag == MacroVal_MList) {
            __auto_type items = _t3556.data.MList.items;
            /* pass */
            __auto_type _t3557 = (*iv);
            if (_t3557.tag == MacroVal_MInt) {
                __auto_type n = _t3557.data.MInt.n;
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3550.tag == Expr_EPropAccess) {
        __auto_type obj = _t3550.data.EPropAccess.obj;
__auto_type prop = _t3550.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t3550.tag == Expr_EMethodCall) {
        __auto_type obj = _t3550.data.EMethodCall.obj;
__auto_type method = _t3550.data.EMethodCall.method;
__auto_type margs = _t3550.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t3558 = (*ov);
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t3559 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3559))); _tr_str_release(_at_t3559); _wr; });
        }
        /* pass */
        ({ TrStr _at_t3560 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3560); _tr_str_release(_at_t3560); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3550.tag == Expr_ECall) {
        __auto_type callee = _t3550.data.ECall.callee;
__auto_type cargs = _t3550.data.ECall.args;
        /* pass */
        __auto_type _t3561 = (*callee);
        if (_t3561.tag == Expr_EIdent) {
            __auto_type cn = _t3561.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3562 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t3562;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3563 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t3563;
                }
                /* pass */
                return ({ TrStr _at_t3564 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3564))); _tr_str_release(_at_t3564); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t3565 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3565))); _tr_str_release(_at_t3565); _wr; });
                }
                /* pass */
        ...
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3550.tag == Expr_EList) {
        __auto_type items = _t3550.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3566 = (*sptr);
    if (_t3566.tag == Stmt_SLet) {
        __auto_type name = _t3566.data.SLet.name;
__auto_type val = _t3566.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t3566.tag == Stmt_SAssign) {
        __auto_type target = _t3566.data.SAssign.target;
__auto_type val = _t3566.data.SAssign.val;
        /* pass */
        __auto_type _t3567 = (*target);
        if (_t3567.tag == Expr_EIdent) {
            __auto_type nm = _t3567.data.EIdent.name;
    ...
    } else if (_t3566.tag == Stmt_SReturn) {
        __auto_type val = _t3566.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t3566.tag == Stmt_SExpr) {
        __auto_type e = _t3566.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t3566.tag == Stmt_SFor) {
        __auto_type var = _t3566.data.SFor.var;
__auto_type iter = _t3566.data.SFor.iter;
__auto_type body = _t3566.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t3568 = (*iv);
        if (_t3568.tag == MacroVal_MList) {
            __auto_type items = _t3568.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t3566.tag == Stmt_SIf) {
        __auto_type cond = _t3566.data.SIf.cond;
__auto_type then_b = _t3566.data.SIf.then_b;
__auto_type elifs = _t3566.data.SIf.elifs;
__auto_type else_b = _t3566.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t3566.tag == Stmt_SPass) {
        /* pass */
    } else if (_t3566.tag == Stmt_SLine) {
        __auto_type _ = _t3566.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3569 = (*eptr);
    if (_t3569.tag == Expr_EMacroCall) {
        __auto_type name = _t3569.data.EMacroCall.name;
__auto_type args = _t3569.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t3569.tag == Expr_EBinOp) {
        __auto_type l = _t3569.data.EBinOp.left;
__auto_type r = _t3569.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t3569.tag == Expr_EUnaryOp) {
        __auto_type x = _t3569.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3569.tag == Expr_ECall) {
        __auto_type callee = _t3569.data.ECall.callee;
__auto_type cargs = _t3569.data.ECall.args;
        /* pass */
    ...
    } else if (_t3569.tag == Expr_EMethodCall) {
        __auto_type obj = _t3569.data.EMethodCall.obj;
__auto_type margs = _t3569.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t3569.tag == Expr_EPropAccess) {
        __auto_type obj = _t3569.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t3569.tag == Expr_EIndex) {
        __auto_type obj = _t3569.data.EIndex.obj;
__auto_type idx = _t3569.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t3569.tag == Expr_ECast) {
        __auto_type x = _t3569.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3569.tag == Expr_ETryExpr) {
        __auto_type x = _t3569.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3569.tag == Expr_EIfElse) {
        __auto_type c = _t3569.data.EIfElse.cond;
__auto_type t = _t3569.data.EIfElse.then_expr;
__auto_type e2 = _t3569.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t3569.tag == Expr_EList) {
        __auto_type items = _t3569.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3569.tag == Expr_ETuple) {
        __auto_type items = _t3569.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3569.tag == Expr_EFString) {
        __auto_type parts = _t3569.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t3569.tag == Expr_EDo) {
        __auto_type body = _t3569.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3569.tag == Expr_ELoop) {
        __auto_type body = _t3569.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3569.tag == Expr_EWhileExpr) {
        __auto_type c = _t3569.data.EWhileExpr.cond;
__auto_type body = _t3569.data.EWhileExpr.body;
__auto_type eb = _t3569.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t3569.tag == Expr_EMatch) {
        __auto_type subj = _t3569.data.EMatch.subj;
__auto_type arms = _t3569.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3570 = (*sptr);
    if (_t3570.tag == Stmt_SExpr) {
        __auto_type e = _t3570.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t3570.tag == Stmt_SLet) {
        __auto_type v = _t3570.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SMultiLet) {
        __auto_type v = _t3570.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SAssign) {
        __auto_type t = _t3570.data.SAssign.target;
__auto_type v = _t3570.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SReturn) {
        __auto_type v = _t3570.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SBreak) {
        __auto_type v = _t3570.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SRaise) {
        __auto_type v = _t3570.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SSpawn) {
        __auto_type v = _t3570.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3570.tag == Stmt_SAssert) {
        __auto_type c = _t3570.data.SAssert.cond;
__auto_type m = _t3570.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t3570.tag == Stmt_SIf) {
        __auto_type c = _t3570.data.SIf.cond;
__auto_type tb = _t3570.data.SIf.then_b;
__auto_type elifs = _t3570.data.SIf.elifs;
__auto_type eb = _t3570.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t3570.tag == Stmt_SWhile) {
        __auto_type c = _t3570.data.SWhile.cond;
__auto_type b = _t3570.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_SFor) {
        __auto_type it = _t3570.data.SFor.iter;
__auto_type b = _t3570.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_SForUnpack) {
        __auto_type it = _t3570.data.SForUnpack.iter;
__auto_type b = _t3570.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_SMatch) {
        __auto_type subj = _t3570.data.SMatch.expr;
__auto_type arms = _t3570.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t3570.tag == Stmt_SWith) {
        __auto_type items = _t3570.data.SWith.items;
__auto_type b = _t3570.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_STry) {
        __auto_type tb = _t3570.data.STry.try_body;
__auto_type catches = _t3570.data.STry.catches;
__auto_type fb = _t3570.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t3570.tag == Stmt_SUnsafe) {
        __auto_type b = _t3570.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_STaskGroup) {
        __auto_type b = _t3570.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_SGpuBlock) {
        __auto_type b = _t3570.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3570.tag == Stmt_SDefer) {
        __auto_type s = _t3570.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t3571 = (*dptr);
    if (_t3571.tag == Decl_DFunction) {
        __auto_type f = _t3571.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t3571.tag == Decl_DClass) {
        __auto_type c = _t3571.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t3572 = (*recptr);
    if (_t3572.tag == MacroVal_MRec) {
        __auto_type keys = _t3572.data.MRec.keys;
__auto_type vals = _t3572.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3573 = (*vptr);
    if (_t3573.tag == MacroVal_MStr) {
        __auto_type s = _t3573.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t3573.tag == MacroVal_MInt) {
        __auto_type n = _t3573.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t3573.tag == MacroVal_MBool) {
        __auto_type b = _t3573.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t3573.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3574 = (*vptr);
    if (_t3574.tag == MacroVal_MBool) {
        __auto_type b = _t3574.data.MBool.b;
        return b;
    } else if (_t3574.tag == MacroVal_MInt) {
        __auto_type n = _t3574.data.MInt.n;
        return (n != 0LL);
    } else if (_t3574.tag == MacroVal_MStr) {
        __auto_type s = _t3574.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t3575 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(s);
                s = _strtmp_t3575;
            }
            /* pass */
            TrStr _strtmp_t3576 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t3576;
            /* pass */
            i = (i + 1LL);
        ...
        /* pass */
        TrStr _strtmp_t3577 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("]")));
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t3578 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t3578))); _tr_str_release(_at_t3578); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t3579 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3579))); _tr_str_release(_at_t3579); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t3580 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t3580;
        }
        /* pass */
        TrStr _strtmp_t3581 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t3581;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t3582 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t3582;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3583 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3583))); _tr_str_release(_at_t3583); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t3584 = (*declptr);
    if (_t3584.tag == Decl_DClass) {
        __auto_type c = _t3584.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t3585 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t3585))); _tr_str_release(_at_t3585); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t3584.tag == Decl_DFunction) {
        __auto_type f = _t3584.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t3584.tag == Decl_DEnum) {
        __auto_type e = _t3584.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t3586 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t3586); _tr_str_release(_at_t3586); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t3584.tag == Decl_DInterface) {
        __auto_type ifc = _t3584.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t3587 = (*declptr);
    if (_t3587.tag == Decl_DClass) {
        __auto_type c = _t3587.data.DClass.cls;
        return c->decorators;
    } else if (_t3587.tag == Decl_DFunction) {
        __auto_type f = _t3587.data.DFunction.func;
        return f->decorators;
    } else if (_t3587.tag == Decl_DEnum) {
        __auto_type e = _t3587.data.DEnum.enm;
        return e->decorators;
    } else if (_t3587.tag == Decl_DInterface) {
        __auto_type ifc = _t3587.data.DInterface.iface;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t3588 = (*e);
    if (_t3588.tag == Expr_ELitInt) {
        __auto_type _ = _t3588.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t3588.tag == Expr_ELitFloat) {
        __auto_type _ = _t3588.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t3588.tag == Expr_ELitStr) {
        __auto_type _ = _t3588.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t3588.tag == Expr_ERawStr) {
        __auto_type _ = _t3588.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t3588.tag == Expr_ELitBool) {
        __auto_type _ = _t3588.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t3588.tag == Expr_ELitChar) {
        __auto_type _ = _t3588.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t3588.tag == Expr_EIdent) {
        __auto_type _ = _t3588.data.EIdent.name;
        return _tr_str_lit("ident");
    } else if (_t3588.tag == Expr_ECall) {
        return _tr_str_lit("call");
    } else if (_t3588.tag == Expr_EMethodCall) {
        return _tr_str_lit("call");
    } else if (_t3588.tag == Expr_EBinOp) {
        return _tr_str_lit("binop");
    } else if (_t3588.tag == Expr_EUnaryOp) {
        return _tr_str_lit("unop");
    } else if (_t3588.tag == Expr_EList) {
        __auto_type _ = _t3588.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t3588.tag == Expr_ETuple) {
        __auto_type _ = _t3588.data.ETuple.items;
        return _tr_str_lit("tuple");
    } else if (_t3588.tag == Expr_EIndex) {
        return _tr_str_lit("index");
    } else if (_t3588.tag == Expr_EPropAccess) {
        return _tr_str_lit("field");
    } else if (_t3588.tag == Expr_EFString) {
        __auto_type _ = _t3588.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t3589 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3589))); _tr_str_release(_at_t3589); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t3590 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3590))); _tr_str_release(_at_t3590); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t3591 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t3591.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3591.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t3592 = (*dptr);
        if (_t3592.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3592.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
