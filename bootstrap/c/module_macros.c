...
__attribute__((hot)) MacroVal* MacroCtx_eval_binop(MacroCtx* self, TrStr op, MacroVal* lv, MacroVal* rv) {
    ...
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("+"))) == 0)) {
        /* pass */
        __auto_type _t3443 = (*lv);
        if (_t3443.tag == MacroVal_MInt) {
            __auto_type a = _t3443.data.MInt.n;
            /* pass */
            __auto_type _t3444 = (*rv);
            if (_t3444.tag == MacroVal_MInt) {
                __auto_type b = _t3444.data.MInt.n;
                return box_mv(MacroVal_ctor_MInt((a + b)));
            } else if (1) {
                __auto_type _ = _t3444;
                return ({ TrStr _at_t3445 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3445))); _tr_str_release(_at_t3445); _wr; });
            }
        } else if (1) {
            __auto_type _ = _t3443;
            return ({ TrStr _at_t3446 = (({ TrStr _cl = (mv_to_str(lv)); TrStr _cr = (mv_to_str(rv)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3446))); _tr_str_release(_at_t3446); _wr; });
        }
    }
    /* pass */
    if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("=="))) == 0)) {
    ...
    /* pass */
    ({ TrStr _at_t3449 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3449); _tr_str_release(_at_t3449); });
    /* pass */
...
__attribute__((hot)) MacroVal* MacroCtx_eval_mexpr(MacroCtx* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3450 = (*eptr);
    if (_t3450.tag == Expr_ELitStr) {
        __auto_type s = _t3450.data.ELitStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3450.tag == Expr_ERawStr) {
        __auto_type s = _t3450.data.ERawStr.val;
        return box_mv(MacroVal_ctor_MStr(s));
    } else if (_t3450.tag == Expr_ELitInt) {
        __auto_type n = _t3450.data.ELitInt.val;
        return box_mv(MacroVal_ctor_MInt(n));
    } else if (_t3450.tag == Expr_ELitBool) {
        __auto_type b = _t3450.data.ELitBool.val;
        return box_mv(MacroVal_ctor_MBool(b));
    } else if (_t3450.tag == Expr_EIdent) {
        __auto_type name = _t3450.data.EIdent.name;
        /* pass */
        ...
        /* pass */
        ({ TrStr _at_t3451 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unknown name '")), _tr_strz(name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("'"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3451); _tr_str_release(_at_t3451); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3450.tag == Expr_EBinOp) {
        __auto_type op = _t3450.data.EBinOp.op;
__auto_type l = _t3450.data.EBinOp.left;
__auto_type r = _t3450.data.EBinOp.right;
        /* pass */
        return MacroCtx_eval_binop(self, op, MacroCtx_eval_mexpr(self, l), MacroCtx_eval_mexpr(self, r));
    } else if (_t3450.tag == Expr_EUnaryOp) {
        __auto_type op = _t3450.data.EUnaryOp.op;
__auto_type x = _t3450.data.EUnaryOp.expr;
        /* pass */
        ...
        if ((strcmp(_tr_strz(op), _tr_strz(_tr_str_lit("-"))) == 0)) {
            /* pass */
            __auto_type _t3452 = (*xv);
            if (_t3452.tag == MacroVal_MInt) {
                __auto_type n = _t3452.data.MInt.n;
        ...
        /* pass */
        ({ TrStr _at_t3453 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported unary operator '")), _tr_strz(op))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3453); _tr_str_release(_at_t3453); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3450.tag == Expr_EFString) {
        __auto_type parts = _t3450.data.EFString.parts;
        /* pass */
        ...
        while ((i < parts->len)) {
            ...
            if (part->is_expr) {
                /* pass */
                TrStr _strtmp_t3454 = ({ TrStr _cr = (mv_to_str(MacroCtx_eval_mexpr(self, part->expr))); TrStr _cres = _tr_strx_concat(_tr_strz(out), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(out);
                out = _strtmp_t3454;
            } else {
                /* pass */
                TrStr _strtmp_t3455 = _tr_strx_concat(_tr_strz(out), _tr_strz(part->text));
                _tr_str_release(out);
                out = _strtmp_t3455;
            }
            /* pass */
        ...
        __auto_type obj = _t3450.data.EIndex.obj;
__auto_type idx = _t3450.data.EIndex._tr_v_index;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, idx);
        /* pass */
        __auto_type _t3456 = (*ov);
        if (_t3456.tag == MacroVal_MList) {
            __auto_type items = _t3456.data.MList.items;
            /* pass */
            __auto_type _t3457 = (*iv);
            if (_t3457.tag == MacroVal_MInt) {
                __auto_type n = _t3457.data.MInt.n;
                /* pass */
        ...
        __auto_type obj = _t3450.data.EPropAccess.obj;
__auto_type prop = _t3450.data.EPropAccess.prop;
        /* pass */
        return mrec_get(MacroCtx_eval_mexpr(self, obj), prop);
    } else if (_t3450.tag == Expr_EMethodCall) {
        __auto_type obj = _t3450.data.EMethodCall.obj;
__auto_type method = _t3450.data.EMethodCall.method;
__auto_type margs = _t3450.data.EMethodCall.args;
        /* pass */
        MacroVal* ov = MacroCtx_eval_mexpr(self, obj);
        /* pass */
        if ((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("len"))) == 0)) {
            /* pass */
            __auto_type _t3458 = (*ov);
            if (_t3458.tag == MacroVal_MList) {
                __auto_type items = _t3458.data.MList.items;
        ...
        if (((strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_str"))) == 0) || (strcmp(_tr_strz(method), _tr_strz(_tr_str_lit("to_string"))) == 0))) {
            /* pass */
            return ({ TrStr _at_t3459 = (mv_to_str(ov)); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3459))); _tr_str_release(_at_t3459); _wr; });
        }
        /* pass */
        ({ TrStr _at_t3460 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("macro: unsupported method '")), _tr_strz(method))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("' in macro body"))); _tr_str_release(_cl); _cres; })); MacroCtx_fail(self, _at_t3460); _tr_str_release(_at_t3460); });
        /* pass */
        return box_mv(MacroVal_make_MNil());
    } else if (_t3450.tag == Expr_ECall) {
        __auto_type callee = _t3450.data.ECall.callee;
__auto_type cargs = _t3450.data.ECall.args;
        /* pass */
        __auto_type _t3461 = (*callee);
        if (_t3461.tag == Expr_EIdent) {
            __auto_type cn = _t3461.data.EIdent.name;
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("macro_error"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3462 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(msg);
                    msg = _strtmp_t3462;
                }
                /* pass */
            ...
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("gensym"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t3463 = mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))));
                    _tr_str_release(pfx);
                    pfx = _strtmp_t3463;
                }
                /* pass */
                return ({ TrStr _at_t3464 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("__hyg_")), _tr_strz(pfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(self->gensym_ctr)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3464))); _tr_str_release(_at_t3464); _wr; });
            }
            /* pass */
            if ((strcmp(_tr_strz(cn), _tr_strz(_tr_str_lit("str"))) == 0)) {
                ...
                if ((cargs->len > 0LL)) {
                    /* pass */
                    return ({ TrStr _at_t3465 = (mv_to_str(MacroCtx_eval_mexpr(self, ((Expr*)List_ptr_get(cargs, 0LL))))); __auto_type _wr = (box_mv(MacroVal_ctor_MStr(_at_t3465))); _tr_str_release(_at_t3465); _wr; });
                }
                /* pass */
        ...
        __auto_type items = _t3450.data.EList.items;
        /* pass */
...
__attribute__((hot)) void MacroCtx_eval_mstmt(MacroCtx* self, Stmt* sptr) {
    ...
    /* pass */
    __auto_type _t3466 = (*sptr);
    if (_t3466.tag == Stmt_SLet) {
        __auto_type name = _t3466.data.SLet.name;
__auto_type val = _t3466.data.SLet.val;
        /* pass */
        _tr_dict_set(self->env, _tr_strz(name), MacroCtx_eval_mexpr(self, val));
    } else if (_t3466.tag == Stmt_SAssign) {
        __auto_type target = _t3466.data.SAssign.target;
__auto_type val = _t3466.data.SAssign.val;
        /* pass */
        __auto_type _t3467 = (*target);
        if (_t3467.tag == Expr_EIdent) {
            __auto_type nm = _t3467.data.EIdent.name;
    ...
    } else if (_t3466.tag == Stmt_SReturn) {
        __auto_type val = _t3466.data.SReturn.val;
        /* pass */
        self->result = mv_to_str(MacroCtx_eval_mexpr(self, val));
        /* pass */
        self->returned = true;
    } else if (_t3466.tag == Stmt_SExpr) {
        __auto_type e = _t3466.data.SExpr.expr;
        /* pass */
        MacroVal* _r = MacroCtx_eval_mexpr(self, e);
    } else if (_t3466.tag == Stmt_SFor) {
        __auto_type var = _t3466.data.SFor.var;
__auto_type iter = _t3466.data.SFor.iter;
__auto_type body = _t3466.data.SFor.body;
        /* pass */
        MacroVal* iv = MacroCtx_eval_mexpr(self, iter);
        /* pass */
        __auto_type _t3468 = (*iv);
        if (_t3468.tag == MacroVal_MList) {
            __auto_type items = _t3468.data.MList.items;
            /* pass */
            long long i = 0LL;
            /* pass */
            while ((i < items->len)) {
    ...
    } else if (_t3466.tag == Stmt_SIf) {
        __auto_type cond = _t3466.data.SIf.cond;
__auto_type then_b = _t3466.data.SIf.then_b;
__auto_type elifs = _t3466.data.SIf.elifs;
__auto_type else_b = _t3466.data.SIf.else_b;
        /* pass */
    ...
    } else if (_t3466.tag == Stmt_SPass) {
        /* pass */
    } else if (_t3466.tag == Stmt_SLine) {
        __auto_type _ = _t3466.data.SLine.n;
        /* pass */
    } else if (1) {
...
__attribute__((hot)) void FnMacroExpander_visit_expr(FnMacroExpander* self, Expr* eptr) {
    ...
    /* pass */
    __auto_type _t3469 = (*eptr);
    if (_t3469.tag == Expr_EMacroCall) {
        __auto_type name = _t3469.data.EMacroCall.name;
__auto_type args = _t3469.data.EMacroCall.args;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < args->len)) {
        ...
        _tr_obj_release(ctx, _trdrop_MacroCtx);
    } else if (_t3469.tag == Expr_EBinOp) {
        __auto_type l = _t3469.data.EBinOp.left;
__auto_type r = _t3469.data.EBinOp.right;
        /* pass */
        FnMacroExpander_visit_expr(self, l);
        /* pass */
        FnMacroExpander_visit_expr(self, r);
    } else if (_t3469.tag == Expr_EUnaryOp) {
        __auto_type x = _t3469.data.EUnaryOp.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3469.tag == Expr_ECall) {
        __auto_type callee = _t3469.data.ECall.callee;
__auto_type cargs = _t3469.data.ECall.args;
        /* pass */
    ...
    } else if (_t3469.tag == Expr_EMethodCall) {
        __auto_type obj = _t3469.data.EMethodCall.obj;
__auto_type margs = _t3469.data.EMethodCall.args;
        /* pass */
    ...
    } else if (_t3469.tag == Expr_EPropAccess) {
        __auto_type obj = _t3469.data.EPropAccess.obj;
        FnMacroExpander_visit_expr(self, obj);
    } else if (_t3469.tag == Expr_EIndex) {
        __auto_type obj = _t3469.data.EIndex.obj;
__auto_type idx = _t3469.data.EIndex._tr_v_index;
        /* pass */
        FnMacroExpander_visit_expr(self, obj);
        /* pass */
        FnMacroExpander_visit_expr(self, idx);
    } else if (_t3469.tag == Expr_ECast) {
        __auto_type x = _t3469.data.ECast.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3469.tag == Expr_ETryExpr) {
        __auto_type x = _t3469.data.ETryExpr.expr;
        FnMacroExpander_visit_expr(self, x);
    } else if (_t3469.tag == Expr_EIfElse) {
        __auto_type c = _t3469.data.EIfElse.cond;
__auto_type t = _t3469.data.EIfElse.then_expr;
__auto_type e2 = _t3469.data.EIfElse.else_expr;
        /* pass */
    ...
    } else if (_t3469.tag == Expr_EList) {
        __auto_type items = _t3469.data.EList.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3469.tag == Expr_ETuple) {
        __auto_type items = _t3469.data.ETuple.items;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
    ...
    } else if (_t3469.tag == Expr_EFString) {
        __auto_type parts = _t3469.data.EFString.parts;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < parts->len)) {
    ...
    } else if (_t3469.tag == Expr_EDo) {
        __auto_type body = _t3469.data.EDo.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3469.tag == Expr_ELoop) {
        __auto_type body = _t3469.data.ELoop.body;
        FnMacroExpander_visit_block(self, body);
    } else if (_t3469.tag == Expr_EWhileExpr) {
        __auto_type c = _t3469.data.EWhileExpr.cond;
__auto_type body = _t3469.data.EWhileExpr.body;
__auto_type eb = _t3469.data.EWhileExpr.else_body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, body);
    ...
    } else if (_t3469.tag == Expr_EMatch) {
        __auto_type subj = _t3469.data.EMatch.subj;
__auto_type arms = _t3469.data.EMatch.arms;
        /* pass */
...
__attribute__((hot)) void FnMacroExpander_visit_stmt(FnMacroExpander* self, Stmt* sptr) {
    ...
    if (_t3470.tag == Stmt_SExpr) {
        __auto_type e = _t3470.data.SExpr.expr;
        FnMacroExpander_visit_expr(self, e);
    } else if (_t3470.tag == Stmt_SLet) {
        __auto_type v = _t3470.data.SLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SMultiLet) {
        __auto_type v = _t3470.data.SMultiLet.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SAssign) {
        __auto_type t = _t3470.data.SAssign.target;
__auto_type v = _t3470.data.SAssign.val;
        /* pass */
        FnMacroExpander_visit_expr(self, t);
        /* pass */
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SReturn) {
        __auto_type v = _t3470.data.SReturn.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SBreak) {
        __auto_type v = _t3470.data.SBreak.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SRaise) {
        __auto_type v = _t3470.data.SRaise.val;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SSpawn) {
        __auto_type v = _t3470.data.SSpawn.expr;
        FnMacroExpander_visit_expr(self, v);
    } else if (_t3470.tag == Stmt_SAssert) {
        __auto_type c = _t3470.data.SAssert.cond;
__auto_type m = _t3470.data.SAssert.msg;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_expr(self, m);
    } else if (_t3470.tag == Stmt_SIf) {
        __auto_type c = _t3470.data.SIf.cond;
__auto_type tb = _t3470.data.SIf.then_b;
__auto_type elifs = _t3470.data.SIf.elifs;
__auto_type eb = _t3470.data.SIf.else_b;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        ...
        /* pass */
        FnMacroExpander_visit_block(self, eb);
    } else if (_t3470.tag == Stmt_SWhile) {
        __auto_type c = _t3470.data.SWhile.cond;
__auto_type b = _t3470.data.SWhile.body;
        /* pass */
        FnMacroExpander_visit_expr(self, c);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_SFor) {
        __auto_type it = _t3470.data.SFor.iter;
__auto_type b = _t3470.data.SFor.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_SForUnpack) {
        __auto_type it = _t3470.data.SForUnpack.iter;
__auto_type b = _t3470.data.SForUnpack.body;
        /* pass */
        FnMacroExpander_visit_expr(self, it);
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_SMatch) {
        __auto_type subj = _t3470.data.SMatch.expr;
__auto_type arms = _t3470.data.SMatch.arms;
        /* pass */
        FnMacroExpander_visit_expr(self, subj);
        /* pass */
        long long i = 0LL;
    ...
    } else if (_t3470.tag == Stmt_SWith) {
        __auto_type items = _t3470.data.SWith.items;
__auto_type b = _t3470.data.SWith.body;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < items->len)) {
        ...
        /* pass */
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_STry) {
        __auto_type tb = _t3470.data.STry.try_body;
__auto_type catches = _t3470.data.STry.catches;
__auto_type fb = _t3470.data.STry.finally_b;
        /* pass */
        FnMacroExpander_visit_block(self, tb);
        /* pass */
    ...
    } else if (_t3470.tag == Stmt_SUnsafe) {
        __auto_type b = _t3470.data.SUnsafe.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_STaskGroup) {
        __auto_type b = _t3470.data.STaskGroup.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_SGpuBlock) {
        __auto_type b = _t3470.data.SGpuBlock.body;
        FnMacroExpander_visit_block(self, b);
    } else if (_t3470.tag == Stmt_SDefer) {
        __auto_type s = _t3470.data.SDefer.stmt;
...
__attribute__((hot)) void FnMacroExpander_expand_decl(FnMacroExpander* self, Decl* dptr) {
    /* pass */
    __auto_type _t3471 = (*dptr);
    if (_t3471.tag == Decl_DFunction) {
        __auto_type f = _t3471.data.DFunction.func;
        FnMacroExpander_visit_block(self, f->body);
    } else if (_t3471.tag == Decl_DClass) {
        __auto_type c = _t3471.data.DClass.cls;
        /* pass */
        long long i = 0LL;
        /* pass */
...
__attribute__((hot)) MacroVal* mrec_get(MacroVal* recptr, TrStr key) {
    ...
    /* pass */
    __auto_type _t3472 = (*recptr);
    if (_t3472.tag == MacroVal_MRec) {
        __auto_type keys = _t3472.data.MRec.keys;
__auto_type vals = _t3472.data.MRec.vals;
        /* pass */
        long long i = 0LL;
        /* pass */
        while ((i < keys->len)) {
...
__attribute__((hot)) TrStr mv_to_str(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3473 = (*vptr);
    if (_t3473.tag == MacroVal_MStr) {
        __auto_type s = _t3473.data.MStr.s;
        return _tr_str_retain(s);
    } else if (_t3473.tag == MacroVal_MInt) {
        __auto_type n = _t3473.data.MInt.n;
        return _tr_str_wrap(_tr_int_to_str((long long)(n)));
    } else if (_t3473.tag == MacroVal_MBool) {
        __auto_type b = _t3473.data.MBool.b;
        /* pass */
        if (b) {
            /* pass */
    ...
    } else if (_t3473.tag == MacroVal_MRec) {
...
__attribute__((hot)) bool mv_truthy(MacroVal* vptr) {
    ...
    /* pass */
    __auto_type _t3474 = (*vptr);
    if (_t3474.tag == MacroVal_MBool) {
        __auto_type b = _t3474.data.MBool.b;
        return b;
    } else if (_t3474.tag == MacroVal_MInt) {
        __auto_type n = _t3474.data.MInt.n;
        return (n != 0LL);
    } else if (_t3474.tag == MacroVal_MStr) {
        __auto_type s = _t3474.data.MStr.s;
...
__attribute__((hot)) TrStr render_type(AstType** typtr) {
    ...
    if ((t->args->len > 0LL)) {
        ...
        while ((i < t->args->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t3475 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(s);
                s = _strtmp_t3475;
            }
            /* pass */
            TrStr _strtmp_t3476 = ({ TrStr _cr = (render_type(((AstType**)List_ptr_get(t->args, i)))); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(s);
            s = _strtmp_t3476;
            /* pass */
            i = (i + 1LL);
...
__attribute__((hot)) MacroVal* str_list(List_TrStr* items) {
    ...
    while ((i < items->len)) {
        /* pass */
        ({ TrStr _at_t3477 = (List_TrStr_get(items, i)); List_ptr_append(l, box_mv(MacroVal_ctor_MStr(_at_t3477))); _tr_str_release(_at_t3477); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
...
__attribute__((hot)) MacroVal* param_rec(Param* p) {
    ...
    /* pass */
    ({ TrStr _at_t3478 = (render_type(p->ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3478))); _tr_str_release(_at_t3478); });
    /* pass */
...
__attribute__((hot)) MacroVal* fn_rec(FunctionDef* f) {
    ...
    while ((ai < f->params->len)) {
        ...
        if ((ai > 0LL)) {
            /* pass */
            TrStr _strtmp_t3479 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(arglist);
            arglist = _strtmp_t3479;
        }
        /* pass */
        TrStr _strtmp_t3480 = _tr_strx_concat(_tr_strz(arglist), _tr_strz(((Param*)List_ptr_get(f->params, ai))->name));
        _tr_str_release(arglist);
        arglist = _strtmp_t3480;
        /* pass */
        ai = (ai + 1LL);
    }
    /* pass */
    ...
    if ((((unsigned long long)(f->throws_ty)) != ((unsigned long long)(0LL)))) {
        /* pass */
        TrStr _strtmp_t3481 = render_type(f->throws_ty);
        _tr_str_release(thr);
        thr = _strtmp_t3481;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _at_t3482 = (render_type(f->ret_ty)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3482))); _tr_str_release(_at_t3482); });
    /* pass */
...
__attribute__((hot)) MacroVal* build_item(Decl* declptr) {
    ...
    /* pass */
    __auto_type _t3483 = (*declptr);
    if (_t3483.tag == Decl_DClass) {
        __auto_type c = _t3483.data.DClass.cls;
        /* pass */
        List_TrStr* ks = (void*)List_TrStr_new();
        /* pass */
        List_ptr* vs = (void*)List_ptr_new();
        ...
        while ((i < c->fields->len)) {
            ...
            /* pass */
            ({ TrStr _at_t3484 = (render_type(fd->ty)); List_ptr_append(fvs, box_mv(MacroVal_ctor_MStr(_at_t3484))); _tr_str_release(_at_t3484); });
            /* pass */
        ...
        /* pass */
        return mrec(ks, vs);
    } else if (_t3483.tag == Decl_DFunction) {
        __auto_type f = _t3483.data.DFunction.func;
        /* pass */
        return fn_rec(f);
    } else if (_t3483.tag == Decl_DEnum) {
        __auto_type e = _t3483.data.DEnum.enm;
        /* pass */
        ...
        while ((i2 < e->variants->len)) {
            ...
            while ((j < vd->fields->len)) {
                /* pass */
                ({ TrStr _at_t3485 = (render_type(((Param*)List_ptr_get(vd->fields, j))->ty)); List_TrStr_append(tys, _at_t3485); _tr_str_release(_at_t3485); });
                /* pass */
                j = (j + 1LL);
            }
            /* pass */
        ...
        /* pass */
        return mrec(ks2, vs2);
    } else if (_t3483.tag == Decl_DInterface) {
        __auto_type ifc = _t3483.data.DInterface.iface;
        /* pass */
...
__attribute__((hot)) List_ptr* decl_decorators(Decl* declptr) {
    /* pass */
    __auto_type _t3486 = (*declptr);
    if (_t3486.tag == Decl_DClass) {
        __auto_type c = _t3486.data.DClass.cls;
        return c->decorators;
    } else if (_t3486.tag == Decl_DFunction) {
        __auto_type f = _t3486.data.DFunction.func;
        return f->decorators;
    } else if (_t3486.tag == Decl_DEnum) {
        __auto_type e = _t3486.data.DEnum.enm;
        return e->decorators;
    } else if (_t3486.tag == Decl_DInterface) {
        __auto_type ifc = _t3486.data.DInterface.iface;
        return ifc->decorators;
    } else if (1) {
        __auto_type _ = _t3486;
...
__attribute__((hot)) TrStr kind_of(Expr* e) {
    ...
    /* pass */
    __auto_type _t3487 = (*e);
    if (_t3487.tag == Expr_ELitInt) {
        __auto_type _ = _t3487.data.ELitInt.val;
        return _tr_str_lit("int");
    } else if (_t3487.tag == Expr_ELitFloat) {
        __auto_type _ = _t3487.data.ELitFloat.val;
        return _tr_str_lit("float");
    } else if (_t3487.tag == Expr_ELitStr) {
        __auto_type _ = _t3487.data.ELitStr.val;
        return _tr_str_lit("str");
    } else if (_t3487.tag == Expr_ERawStr) {
        __auto_type _ = _t3487.data.ERawStr.val;
        return _tr_str_lit("str");
    } else if (_t3487.tag == Expr_ELitBool) {
        __auto_type _ = _t3487.data.ELitBool.val;
        return _tr_str_lit("bool");
    } else if (_t3487.tag == Expr_ELitChar) {
        __auto_type _ = _t3487.data.ELitChar.val;
        return _tr_str_lit("char");
    } else if (_t3487.tag == Expr_EIdent) {
        __auto_type _ = _t3487.data.EIdent.name;
        return _tr_str_lit("ident");
    } else if (_t3487.tag == Expr_ECall) {
        return _tr_str_lit("call");
    } else if (_t3487.tag == Expr_EMethodCall) {
        return _tr_str_lit("call");
    } else if (_t3487.tag == Expr_EBinOp) {
        return _tr_str_lit("binop");
    } else if (_t3487.tag == Expr_EUnaryOp) {
        return _tr_str_lit("unop");
    } else if (_t3487.tag == Expr_EList) {
        __auto_type _ = _t3487.data.EList.items;
        return _tr_str_lit("list");
    } else if (_t3487.tag == Expr_ETuple) {
        __auto_type _ = _t3487.data.ETuple.items;
        return _tr_str_lit("tuple");
    } else if (_t3487.tag == Expr_EIndex) {
        return _tr_str_lit("index");
    } else if (_t3487.tag == Expr_EPropAccess) {
        return _tr_str_lit("field");
    } else if (_t3487.tag == Expr_EFString) {
        __auto_type _ = _t3487.data.EFString.parts;
...
__attribute__((hot)) MacroVal* arg_rec(Expr* e) {
    ...
    /* pass */
    ({ TrStr _at_t3488 = (render_arg(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3488))); _tr_str_release(_at_t3488); });
    /* pass */
    List_TrStr_append(ks, _tr_str_lit("kind"));
    /* pass */
    ({ TrStr _at_t3489 = (kind_of(e)); List_ptr_append(vs, box_mv(MacroVal_ctor_MStr(_at_t3489))); _tr_str_release(_at_t3489); });
    /* pass */
    return mrec(ks, vs);
}
...
__attribute__((hot)) long long expand_macros(Program* prog) {
    ...
    while ((i < prog->decls->len)) {
        /* pass */
        __auto_type _t3490 = (*((Decl*)List_ptr_get(prog->decls, i)));
        if (_t3490.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3490.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
    ...
    while ((i < prog->decls->len)) {
        ...
        /* pass */
        __auto_type _t3491 = (*dptr);
        if (_t3491.tag == Decl_DDecoratorDef) {
            __auto_type f = _t3491.data.DDecoratorDef.func;
            /* pass */
            if (f->is_macro) {
                /* pass */
                is_macro_def = true;
