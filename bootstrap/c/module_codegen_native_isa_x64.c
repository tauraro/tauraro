...
__attribute__((malloc,returns_nonnull,hot)) EncodedFunc* EncodedFunc_init(TrStr name) {
    ...
    e->is_main = false;
    /* pass */
    ByteBuf* _cltmp_t3430 = ByteBuf_init();
...
__attribute__((hot)) EncodedFunc* encode_func(LFunc* lf) {
    ...
    while ((ppi < lf->params->len)) {
        /* pass */
        ({ TrStr _at_t3431 = (List_TrStr_get(lf->params, ppi)); _st_argreg(c, ppi, _var_disp(lf, _at_t3431)); _tr_str_release(_at_t3431); });
        /* pass */
        ppi = (ppi + 1LL);
    }
    /* pass */
    ...
    while ((bi < lf->blocks->len)) {
        ...
        while ((ii < blk->insts->len)) {
            /* pass */
            __auto_type _t3432 = (*((LInst*)List_ptr_get(blk->insts, ii)));
            if (_t3432.tag == LInst_IConst) {
                __auto_type dst = _t3432.data.IConst.dst;
__auto_type v = _t3432.data.IConst.v;
                /* pass */
                _mov_rax_imm64(c, v);
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IStr) {
                __auto_type dst = _t3432.data.IStr.dst;
__auto_type sidx = _t3432.data.IStr.str_idx;
                /* pass */
                ByteBuf_u8(c, 72LL);
                /* pass */
                ByteBuf_u8(c, 141LL);
            ...
            } else if (_t3432.tag == LInst_ILoadVar) {
                __auto_type dst = _t3432.data.ILoadVar.dst;
__auto_type name = _t3432.data.ILoadVar.name;
                /* pass */
                _ld_rax(c, _var_disp(lf, name));
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IStoreVar) {
                __auto_type name = _t3432.data.IStoreVar.name;
__auto_type src = _t3432.data.IStoreVar.src;
                /* pass */
                _ld_rax(c, _vreg_disp(src));
                /* pass */
                _st_rax(c, _var_disp(lf, name));
            } else if (_t3432.tag == LInst_ILoadGlobal) {
                __auto_type dst = _t3432.data.ILoadGlobal.dst;
__auto_type gidx = _t3432.data.ILoadGlobal.gidx;
                /* pass */
                ByteBuf_u8(c, 72LL);
                /* pass */
                ByteBuf_u8(c, 139LL);
            ...
            } else if (_t3432.tag == LInst_IStoreGlobal) {
                __auto_type gidx = _t3432.data.IStoreGlobal.gidx;
__auto_type src = _t3432.data.IStoreGlobal.src;
                /* pass */
                _ld_rax(c, _vreg_disp(src));
                /* pass */
                ByteBuf_u8(c, 72LL);
            ...
            } else if (_t3432.tag == LInst_IBinOp) {
                __auto_type dst = _t3432.data.IBinOp.dst;
__auto_type op = _t3432.data.IBinOp.op;
__auto_type a = _t3432.data.IBinOp.a;
__auto_type b = _t3432.data.IBinOp.b;
                /* pass */
                ...
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_ICall) {
                __auto_type dst = _t3432.data.ICall.dst;
__auto_type callee = _t3432.data.ICall.callee;
__auto_type args = _t3432.data.ICall.args;
                /* pass */
                long long ai = 0LL;
                /* pass */
                while ((ai < args->len)) {
            ...
            } else if (_t3432.tag == LInst_IFBinOp) {
                __auto_type dst = _t3432.data.IFBinOp.dst;
__auto_type op = _t3432.data.IFBinOp.op;
__auto_type a = _t3432.data.IFBinOp.a;
__auto_type b = _t3432.data.IFBinOp.b;
                /* pass */
            ...
            } else if (_t3432.tag == LInst_IIToF) {
                __auto_type dst = _t3432.data.IIToF.dst;
__auto_type src = _t3432.data.IIToF.src;
                /* pass */
                _ld_rax(c, _vreg_disp(src));
                /* pass */
                ByteBuf_u8(c, 242LL);
                ...
                /* pass */
                _st_xmm0(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IFToI) {
                __auto_type dst = _t3432.data.IFToI.dst;
__auto_type src = _t3432.data.IFToI.src;
                /* pass */
                ...
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IFCall1) {
                __auto_type dst = _t3432.data.IFCall1.dst;
__auto_type callee = _t3432.data.IFCall1.callee;
__auto_type arg = _t3432.data.IFCall1.arg;
                /* pass */
            ...
            } else if (_t3432.tag == LInst_IFCallF) {
                __auto_type dst = _t3432.data.IFCallF.dst;
__auto_type callee = _t3432.data.IFCallF.callee;
__auto_type arg = _t3432.data.IFCallF.arg;
                /* pass */
                _ld_xmm0(c, _vreg_disp(arg));
                /* pass */
                ByteBuf_u8(c, 232LL);
            ...
            } else if (_t3432.tag == LInst_IFCall2F) {
                __auto_type dst = _t3432.data.IFCall2F.dst;
__auto_type callee = _t3432.data.IFCall2F.callee;
__auto_type a = _t3432.data.IFCall2F.a;
__auto_type b = _t3432.data.IFCall2F.b;
                /* pass */
                _ld_xmm0(c, _vreg_disp(a));
                /* pass */
                _ld_xmm1(c, _vreg_disp(b));
            ...
            } else if (_t3432.tag == LInst_IBitsF) {
                __auto_type dst = _t3432.data.IBitsF.dst;
__auto_type src = _t3432.data.IBitsF.src;
                /* pass */
                _ld_rax(c, _vreg_disp(src));
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IFBits) {
                __auto_type dst = _t3432.data.IFBits.dst;
__auto_type src = _t3432.data.IFBits.src;
                /* pass */
                _ld_rax(c, _vreg_disp(src));
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IAddrVar) {
                __auto_type dst = _t3432.data.IAddrVar.dst;
__auto_type name = _t3432.data.IAddrVar.name;
                /* pass */
                ByteBuf_u8(c, 72LL);
                /* pass */
                ByteBuf_u8(c, 141LL);
                ...
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IAddrGlobal) {
                /* pass */
                _emit_return(c, 0LL);
            } else if (_t3432.tag == LInst_IFuncAddr) {
                __auto_type dst = _t3432.data.IFuncAddr.dst;
__auto_type fname = _t3432.data.IFuncAddr.fname;
                /* pass */
                ByteBuf_u8(c, 72LL);
                /* pass */
                ByteBuf_u8(c, 141LL);
            ...
            } else if (_t3432.tag == LInst_ICallInd) {
                __auto_type dst = _t3432.data.ICallInd.dst;
__auto_type fnreg = _t3432.data.ICallInd.fnreg;
__auto_type iargs = _t3432.data.ICallInd.args;
                /* pass */
                long long ci = 0LL;
                /* pass */
                while ((ci < iargs->len)) {
            ...
            } else if (_t3432.tag == LInst_IAsm) {
                __auto_type acode = _t3432.data.IAsm.code;
__auto_type acons = _t3432.data.IAsm.cons;
                /* pass */
                /* pass */
            } else if (_t3432.tag == LInst_ILoad) {
                __auto_type dst = _t3432.data.ILoad.dst;
__auto_type base = _t3432.data.ILoad.base;
__auto_type off = _t3432.data.ILoad.off;
                /* pass */
                ...
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IStore) {
                __auto_type base = _t3432.data.IStore.base;
__auto_type off = _t3432.data.IStore.off;
__auto_type src = _t3432.data.IStore.src;
                /* pass */
                _ld_rax(c, _vreg_disp(base));
                /* pass */
                ...
                /* pass */
                ByteBuf_u32(c, off);
            } else if (_t3432.tag == LInst_ILoadB) {
                __auto_type dst = _t3432.data.ILoadB.dst;
__auto_type base = _t3432.data.ILoadB.base;
__auto_type off = _t3432.data.ILoadB.off;
                /* pass */
                _ld_rax(c, _vreg_disp(base));
                /* pass */
                ByteBuf_u8(c, 15LL);
                ...
                /* pass */
                _st_rax(c, _vreg_disp(dst));
            } else if (_t3432.tag == LInst_IStoreB) {
                __auto_type base = _t3432.data.IStoreB.base;
__auto_type off = _t3432.data.IStoreB.off;
__auto_type src = _t3432.data.IStoreB.src;
                /* pass */
                _ld_rax(c, _vreg_disp(base));
                /* pass */
                _ld_rcx(c, _vreg_disp(src));
        ...
        /* pass */
        __auto_type _t3433 = blk->term;
        if (_t3433.tag == LTerm_TRetInt) {
            __auto_type rv = _t3433.data.TRetInt.v;
            /* pass */
            _emit_return(c, rv);
        } else if (_t3433.tag == LTerm_TRetVal) {
            __auto_type rvreg = _t3433.data.TRetVal.v;
            /* pass */
            ...
            /* pass */
            ByteBuf_u8(c, 195LL);
        } else if (_t3433.tag == LTerm_TRetVoid) {
            /* pass */
            _emit_return(c, 0LL);
        } else if (_t3433.tag == LTerm_TBr) {
            __auto_type target = _t3433.data.TBr.target;
            /* pass */
            ByteBuf_u8(c, 233LL);
            /* pass */
        ...
        } else if (_t3433.tag == LTerm_TCondBr) {
            __auto_type cond = _t3433.data.TCondBr.cond;
__auto_type tb = _t3433.data.TCondBr.then_b;
__auto_type eb = _t3433.data.TCondBr.else_b;
            /* pass */
