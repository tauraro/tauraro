...
__attribute__((hot)) TrStr detect_c_compiler() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3496 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3496;
    }
    /* pass */
    if (({ TrStr _aet_t3497 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("gcc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3497.data) == 0LL)); _tr_str_release(_aet_t3497); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("gcc");
    }
    /* pass */
    if (({ TrStr _aet_t3498 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3498.data) == 0LL)); _tr_str_release(_aet_t3498); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
    /* pass */
    if (({ TrStr _aet_t3499 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("cc --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3499.data) == 0LL)); _tr_str_release(_aet_t3499); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("cc");
    }
    /* pass */
    if (({ TrStr _aet_t3500 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3500.data) == 0LL)); _tr_str_release(_aet_t3500); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
...
__attribute__((hot)) bool is_clang_compiler(TrStr cc) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3501 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3501;
    }
    /* pass */
    ...
    if (_tr_str_eq(_tr_strz(cc), _tr_strz(_tr_str_lit("cc")))) {
        /* pass */
        _tr_str_release(null_dev);
        return ({ TrStr _aet_t3502 = (_tr_strx_concat(_tr_strz(cc), _tr_strz(_tr_str_lit(" --version 2>&1 | grep -qi clang")))); __auto_type _wr = ((_tr_system(_aet_t3502.data) == 0LL)); _tr_str_release(_aet_t3502); _wr; });
    }
    /* pass */
    _tr_str_release(null_dev);
    return false;
...
__attribute__((hot)) TrStr pkg_config_query(TrStr name, TrStr kind) {
    ...
    /* pass */
    long long rc = ({ TrStr _aet_t3504 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("pkg-config ")), _tr_strz(kind))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" > \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(tmp)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(null_dev)); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3504.data)); _tr_str_release(_aet_t3504); _wr; });
    /* pass */
    if ((rc != 0LL)) {
        /* pass */
        _tr_str_release(null_dev);
    ...
    while ((mi < mod_file_paths->len)) {
        ...
        while ((li < lines->len)) {
            ...
            if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-shim:"))) {
                /* pass */
                TrStr _strtmp_t3506 = ({ TrStr _wt_t3505 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 19LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3505.data))); _tr_str_release(_wt_t3505); _wr; });
                _tr_str_release(shim);
                shim = _strtmp_t3506;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-cflags:"))) {
                /* pass */
                TrStr _strtmp_t3508 = ({ TrStr _wt_t3507 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 21LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3507.data))); _tr_str_release(_wt_t3507); _wr; });
                _tr_str_release(cflags);
                cflags = _strtmp_t3508;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-linkflags:"))) {
                /* pass */
                TrStr _strtmp_t3510 = ({ TrStr _wt_t3509 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 24LL, _tr_strlen(_tr_strz(ln))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3509.data))); _tr_str_release(_wt_t3509); _wr; });
                _tr_str_release(linkflags);
                linkflags = _strtmp_t3510;
            } else if (str_starts_with(ln, _tr_str_lit("# tauraro-cpp-lib:"))) {
                /* pass */
                ({ TrStr _wt_t3511 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 18LL, _tr_strlen(_tr_strz(ln))))); TrStr _wt_t3512 = (_tr_str_wrap(_tr_str_strip(_wt_t3511.data))); TrStr _wt_t3513 = (_tr_str_wrap(_tr_str_slice(_tr_strz(ln), 18LL, _tr_strlen(_tr_strz(ln))))); TrStr _at_t3514 = (_tr_str_wrap(_tr_str_strip(_wt_t3513.data))); List_TrStr_append(libs, _at_t3514); _tr_str_release(_wt_t3511); _tr_str_release(_wt_t3512); _tr_str_release(_wt_t3513); _tr_str_release(_at_t3514); });
        ...
        if ((strcmp(_tr_strz(shim), _tr_strz(_tr_str_lit(""))) != 0)) {
            ...
            if ((!file_exists(shim_src))) {
                ...
                if (file_exists(cand)) {
                    /* pass */
                    TrStr _strtmp_t3515 = _tr_str_retain(cand);
                    _tr_str_release(shim_src);
                    shim_src = _strtmp_t3515;
                } else {
                    /* pass */
            ...
            if ((!_tr_dict_contains(seen, _tr_strz(shim_src)))) {
                ...
                if (is_c_only) {
                    /* pass */
                    TrStr _strtmp_t3516 = _tr_strx_concat(_tr_strz(_tr_str_lit("C\n")), _tr_strz(shim_txt));
                    _tr_str_release(cache_key);
                    cache_key = _strtmp_t3516;
                }
                /* pass */
                bool need = true;
                /* pass */
                ...
                if (need) {
                    ...
                    if (is_c_only) {
                        ...
                        if ((!_tr_str_contains(_tr_strz(cflags), _tr_strz(_tr_str_lit("-std"))))) {
                            /* pass */
                            TrStr _strtmp_t3518 = _tr_str_lit(" -std=c++17");
                            _tr_str_release(stdflag);
                            stdflag = _strtmp_t3518;
                        }
                        /* pass */
                        ...
                        if (lto) {
                            /* pass */
                            TrStr _strtmp_t3519 = _tr_str_lit(" -flto");
                            _tr_str_release(ltof);
                            ltof = _strtmp_t3519;
                        }
                        /* pass */
                        TrStr _strtmp_t3520 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cxx), _tr_strz(_tr_str_lit(" -O")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(opt_level)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ltof)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(stdflag)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -c \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(shim_src)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cflags)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(oname)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                        _tr_str_release(ccmd);
                        ccmd = _strtmp_t3520;
                        /* pass */
                        if (verbose) {
                ...
                while ((bi < libs->len)) {
                    /* pass */
                    ({ TrStr _at_t3521 = (({ TrStr _cr = (List_TrStr_get(libs, bi)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3521); _tr_str_release(_at_t3521); });
                    /* pass */
                    bi = (bi + 1LL);
                }
...
__attribute__((hot)) TrStr linker_script_cortex_m() {
    ...
    /* pass */
    TrStr _strtmp_t3522 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_tr_reset)\n")));
    _tr_str_release(s);
    s = _strtmp_t3522;
    /* pass */
    ...
    s = _strtmp_t3523;
    /* pass */
    TrStr _strtmp_t3524 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  FLASH (rx)  : ORIGIN = 0x00000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3524;
    /* pass */
    TrStr _strtmp_t3525 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM   (rwx) : ORIGIN = 0x20000000, LENGTH = 4M\n")));
    _tr_str_release(s);
    s = _strtmp_t3525;
    /* pass */
    TrStr _strtmp_t3526 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3526;
    /* pass */
    TrStr _strtmp_t3527 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3527;
    /* pass */
    TrStr _strtmp_t3528 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .isr_vector : { KEEP(*(.isr_vector)) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3528;
    /* pass */
    TrStr _strtmp_t3529 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { *(.text*) *(.rodata*) } > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3529;
    /* pass */
    TrStr _strtmp_t3530 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _sidata = LOADADDR(.data);\n")));
    _tr_str_release(s);
    s = _strtmp_t3530;
    /* pass */
    TrStr _strtmp_t3531 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { _sdata = .; *(.data*) _edata = .; } > RAM AT > FLASH\n")));
    _tr_str_release(s);
    s = _strtmp_t3531;
    /* pass */
    TrStr _strtmp_t3532 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3532;
    /* pass */
    TrStr _strtmp_t3533 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(8);\n")));
    _tr_str_release(s);
    s = _strtmp_t3533;
    /* pass */
    TrStr _strtmp_t3534 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3534;
    /* pass */
    TrStr _strtmp_t3535 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = ORIGIN(RAM) + LENGTH(RAM);\n")));
    _tr_str_release(s);
    s = _strtmp_t3535;
    /* pass */
    TrStr _strtmp_t3536 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3536;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr linker_script_riscv() {
    ...
    /* pass */
    TrStr _strtmp_t3537 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("ENTRY(_start)\n")));
    _tr_str_release(s);
    s = _strtmp_t3537;
    /* pass */
    TrStr _strtmp_t3538 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("MEMORY {\n")));
    _tr_str_release(s);
    s = _strtmp_t3538;
    /* pass */
    TrStr _strtmp_t3539 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  RAM (rwx) : ORIGIN = 0x80000000, LENGTH = 128M\n")));
    _tr_str_release(s);
    s = _strtmp_t3539;
    /* pass */
    ...
    s = _strtmp_t3540;
    /* pass */
    TrStr _strtmp_t3541 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("SECTIONS {\n")));
    _tr_str_release(s);
    s = _strtmp_t3541;
    /* pass */
    TrStr _strtmp_t3542 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .text : { KEEP(*(.text.init)) *(.text*) *(.rodata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3542;
    /* pass */
    TrStr _strtmp_t3543 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .data : { *(.data*) *(.sdata*) } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3543;
    /* pass */
    TrStr _strtmp_t3544 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  .bss  : { __bss_start__ = .; *(.bss* .sbss* COMMON) __bss_end__ = .; } > RAM\n")));
    _tr_str_release(s);
    s = _strtmp_t3544;
    /* pass */
    TrStr _strtmp_t3545 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = ALIGN(16);\n")));
    _tr_str_release(s);
    s = _strtmp_t3545;
    /* pass */
    TrStr _strtmp_t3546 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  . = . + 0x8000;\n")));
    _tr_str_release(s);
    s = _strtmp_t3546;
    /* pass */
    TrStr _strtmp_t3547 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("  _stack_top = .;\n")));
    _tr_str_release(s);
    s = _strtmp_t3547;
    /* pass */
    TrStr _strtmp_t3548 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3548;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr uefi_zig_stub(TrStr entry_name, bool has_heap_init, long long heap_size_mb) {
    ...
    /* pass */
    TrStr _strtmp_t3549 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const std = @import(\"std\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3549;
    /* pass */
    TrStr _strtmp_t3550 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const uefi = std.os.uefi;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3550;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3551 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn tauraro_heap_init(base: [*]u8, size: usize) void;\n")));
        _tr_str_release(s);
        s = _strtmp_t3551;
    }
    /* pass */
    TrStr _strtmp_t3552 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(fb: [*]u32, width: c_longlong, height: c_longlong, pitch: c_longlong) void;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3552;
    /* pass */
    TrStr _strtmp_t3553 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const HEAP_SIZE: usize = ")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(heap_size_mb)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" * 1024 * 1024;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3553;
    /* pass */
    TrStr _strtmp_t3554 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("pub fn main() void {\n")));
    _tr_str_release(s);
    s = _strtmp_t3554;
    /* pass */
    TrStr _strtmp_t3555 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const bs = uefi.system_table.boot_services.?;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3555;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3556 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const heap_bytes = bs.allocatePool(.loader_data, HEAP_SIZE) catch return;\n")));
        _tr_str_release(s);
        s = _strtmp_t3556;
        /* pass */
        TrStr _strtmp_t3557 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    tauraro_heap_init(heap_bytes.ptr, HEAP_SIZE);\n\n")));
        _tr_str_release(s);
        s = _strtmp_t3557;
    }
    /* pass */
    TrStr _strtmp_t3558 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const gop = (bs.locateProtocol(uefi.protocol.GraphicsOutput, null) catch return) orelse return;\n")));
    _tr_str_release(s);
    s = _strtmp_t3558;
    /* pass */
    TrStr _strtmp_t3559 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const mode = gop.mode;\n")));
    _tr_str_release(s);
    s = _strtmp_t3559;
    /* pass */
    TrStr _strtmp_t3560 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const fb: [*]u32 = @ptrFromInt(mode.frame_buffer_base);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3560;
    /* pass */
    TrStr _strtmp_t3561 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3561;
    /* pass */
    TrStr _strtmp_t3562 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        fb,\n")));
    _tr_str_release(s);
    s = _strtmp_t3562;
    /* pass */
    TrStr _strtmp_t3563 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.horizontal_resolution),\n")));
    _tr_str_release(s);
    s = _strtmp_t3563;
    /* pass */
    TrStr _strtmp_t3564 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.vertical_resolution),\n")));
    _tr_str_release(s);
    s = _strtmp_t3564;
    /* pass */
    TrStr _strtmp_t3565 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        @intCast(mode.info.pixels_per_scan_line),\n")));
    _tr_str_release(s);
    s = _strtmp_t3565;
    /* pass */
    TrStr _strtmp_t3566 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    );\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3566;
    /* pass */
    TrStr _strtmp_t3567 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3567;
    /* pass */
    TrStr _strtmp_t3568 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        asm volatile (\"hlt\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3568;
    /* pass */
    TrStr _strtmp_t3569 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    }\n")));
    _tr_str_release(s);
    s = _strtmp_t3569;
    /* pass */
    TrStr _strtmp_t3570 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3570;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr uefi_zig_stub_frame(TrStr entry_name, bool has_heap_init, long long heap_size_mb) {
    ...
    /* pass */
    TrStr _strtmp_t3571 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const std = @import(\"std\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3571;
    /* pass */
    TrStr _strtmp_t3572 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const uefi = std.os.uefi;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3572;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3573 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("extern fn tauraro_heap_init(base: [*]u8, size: usize) void;\n")));
        _tr_str_release(s);
        s = _strtmp_t3573;
    }
    /* pass */
    ...
    s = _strtmp_t3574;
    /* pass */
    TrStr _strtmp_t3575 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("const HEAP_SIZE: usize = ")))); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(heap_size_mb)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" * 1024 * 1024;\n\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3575;
    /* pass */
    TrStr _strtmp_t3576 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("pub fn main() void {\n")));
    _tr_str_release(s);
    s = _strtmp_t3576;
    /* pass */
    TrStr _strtmp_t3577 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const bs = uefi.system_table.boot_services.?;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3577;
    /* pass */
    if (has_heap_init) {
        /* pass */
        TrStr _strtmp_t3578 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const heap_bytes = bs.allocatePool(.loader_data, HEAP_SIZE) catch return;\n")));
        _tr_str_release(s);
        s = _strtmp_t3578;
        /* pass */
        TrStr _strtmp_t3579 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    tauraro_heap_init(heap_bytes.ptr, HEAP_SIZE);\n\n")));
        _tr_str_release(s);
        s = _strtmp_t3579;
    }
    /* pass */
    TrStr _strtmp_t3580 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const gop = (bs.locateProtocol(uefi.protocol.GraphicsOutput, null) catch return) orelse return;\n")));
    _tr_str_release(s);
    s = _strtmp_t3580;
    /* pass */
    TrStr _strtmp_t3581 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const mode = gop.mode;\n")));
    _tr_str_release(s);
    s = _strtmp_t3581;
    /* pass */
    TrStr _strtmp_t3582 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const fb: [*]u32 = @ptrFromInt(mode.frame_buffer_base);\n")));
    _tr_str_release(s);
    s = _strtmp_t3582;
    /* pass */
    TrStr _strtmp_t3583 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const width: i64 = @intCast(mode.info.horizontal_resolution);\n")));
    _tr_str_release(s);
    s = _strtmp_t3583;
    /* pass */
    TrStr _strtmp_t3584 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const height: i64 = @intCast(mode.info.vertical_resolution);\n")));
    _tr_str_release(s);
    s = _strtmp_t3584;
    /* pass */
    TrStr _strtmp_t3585 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const pitch: i64 = @intCast(mode.info.pixels_per_scan_line);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3585;
    /* pass */
    TrStr _strtmp_t3586 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    const pointer = bs.locateProtocol(uefi.protocol.SimplePointer, null) catch null;\n")));
    _tr_str_release(s);
    s = _strtmp_t3586;
    /* pass */
    TrStr _strtmp_t3587 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    var mouse_x: i64 = @divTrunc(width, 2);\n")));
    _tr_str_release(s);
    s = _strtmp_t3587;
    /* pass */
    TrStr _strtmp_t3588 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    var mouse_y: i64 = @divTrunc(height, 2);\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3588;
    /* pass */
    TrStr _strtmp_t3589 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3589;
    /* pass */
    TrStr _strtmp_t3590 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var mouse_down = false;\n")));
    _tr_str_release(s);
    s = _strtmp_t3590;
    /* pass */
    TrStr _strtmp_t3591 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (pointer) |ptr| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3591;
    /* pass */
    TrStr _strtmp_t3592 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            if (ptr.getState()) |st| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3592;
    /* pass */
    TrStr _strtmp_t3593 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_x += st.relative_movement_x;\n")));
    _tr_str_release(s);
    s = _strtmp_t3593;
    /* pass */
    TrStr _strtmp_t3594 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_y += st.relative_movement_y;\n")));
    _tr_str_release(s);
    s = _strtmp_t3594;
    /* pass */
    TrStr _strtmp_t3595 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_x < 0) mouse_x = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3595;
    /* pass */
    TrStr _strtmp_t3596 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_y < 0) mouse_y = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3596;
    /* pass */
    TrStr _strtmp_t3597 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_x >= width) mouse_x = width - 1;\n")));
    _tr_str_release(s);
    s = _strtmp_t3597;
    /* pass */
    TrStr _strtmp_t3598 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                if (mouse_y >= height) mouse_y = height - 1;\n")));
    _tr_str_release(s);
    s = _strtmp_t3598;
    /* pass */
    TrStr _strtmp_t3599 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                mouse_down = st.left_button;\n")));
    _tr_str_release(s);
    s = _strtmp_t3599;
    /* pass */
    TrStr _strtmp_t3600 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            } else |_| {}\n")));
    _tr_str_release(s);
    s = _strtmp_t3600;
    /* pass */
    TrStr _strtmp_t3601 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        }\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3601;
    /* pass */
    TrStr _strtmp_t3602 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var has_key = false;\n")));
    _tr_str_release(s);
    s = _strtmp_t3602;
    /* pass */
    TrStr _strtmp_t3603 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        var key_code: i64 = 0;\n")));
    _tr_str_release(s);
    s = _strtmp_t3603;
    /* pass */
    TrStr _strtmp_t3604 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (uefi.system_table.con_in) |con_in| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3604;
    /* pass */
    TrStr _strtmp_t3605 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            if (con_in.readKeyStroke()) |k| {\n")));
    _tr_str_release(s);
    s = _strtmp_t3605;
    /* pass */
    TrStr _strtmp_t3606 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                has_key = true;\n")));
    _tr_str_release(s);
    s = _strtmp_t3606;
    /* pass */
    TrStr _strtmp_t3607 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("                key_code = k.unicode_char;\n")));
    _tr_str_release(s);
    s = _strtmp_t3607;
    /* pass */
    TrStr _strtmp_t3608 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("            } else |_| {}\n")));
    _tr_str_release(s);
    s = _strtmp_t3608;
    /* pass */
    TrStr _strtmp_t3609 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        }\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3609;
    /* pass */
    TrStr _strtmp_t3610 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        const keep_going = ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(entry_name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(fb, width, height, pitch, mouse_x, mouse_y, mouse_down, has_key, key_code);\n"))); _tr_str_release(_cl); _cres; });
    _tr_str_release(s);
    s = _strtmp_t3610;
    /* pass */
    TrStr _strtmp_t3611 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        if (!keep_going) break;\n\n")));
    _tr_str_release(s);
    s = _strtmp_t3611;
    /* pass */
    TrStr _strtmp_t3612 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        bs.stall(16_000) catch {};\n")));
    _tr_str_release(s);
    s = _strtmp_t3612;
    /* pass */
    TrStr _strtmp_t3613 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    }\n")));
    _tr_str_release(s);
    s = _strtmp_t3613;
    /* pass */
    TrStr _strtmp_t3614 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    while (true) {\n")));
    _tr_str_release(s);
    s = _strtmp_t3614;
    /* pass */
    TrStr _strtmp_t3615 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("        asm volatile (\"hlt\");\n")));
    _tr_str_release(s);
    s = _strtmp_t3615;
    /* pass */
    TrStr _strtmp_t3616 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("    }\n")));
    _tr_str_release(s);
    s = _strtmp_t3616;
    /* pass */
    TrStr _strtmp_t3617 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit("}\n")));
    _tr_str_release(s);
    s = _strtmp_t3617;
    /* pass */
    return s;
...
__attribute__((hot)) TrStr detect_cross_compiler(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3618 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3618;
    }
    /* pass */
    if (_tr_str_contains(_tr_strz(triple), _tr_strz(_tr_str_lit("android")))) {
        ...
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3619 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("ANDROID_NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3619;
        }
        /* pass */
        if ((strcmp(_tr_strz(ndk), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            TrStr _strtmp_t3620 = _tr_str_lit(_tr_getenv(_tr_strz(_tr_str_lit("NDK_HOME"))));
            _tr_str_release(ndk);
            ndk = _strtmp_t3620;
        }
        /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3622 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3622.data) == 0LL)); _tr_str_release(_aet_t3622); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        return _tr_str_lit("clang");
    }
...
__attribute__((hot)) TrStr detect_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3624 = path_to_native(z);
        _tr_str_release(z);
        z = _strtmp_t3624;
    }
    /* pass */
...
__attribute__((hot)) bool activate_bundled_zig() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3625 = path_to_native(zdir);
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3626 = _tr_str_lit(";");
        _tr_str_release(sep);
        sep = _strtmp_t3626;
    }
    /* pass */
    ...
    /* pass */
    ({ TrStr _aet_t3627 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(zdir), _tr_strz(sep))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cur)); _tr_str_release(_cl); _cres; })); _tr_setenv(_tr_strz(_tr_str_lit("PATH")), _aet_t3627.data); _tr_str_release(_aet_t3627); });
    /* pass */
    _tr_str_release(zbin);
    _tr_str_release(zdir);
    _tr_str_release(sep);
...
__attribute__((hot)) TrStr detect_lld_flag() {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3629 = _tr_str_lit(".exe");
        _tr_str_release(ext);
        ext = _strtmp_t3629;
    }
    /* pass */
    ...
    /* pass */
    if (({ TrStr _aet_t3632 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("ld.lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3632.data) == 0LL)); _tr_str_release(_aet_t3632); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
    ...
    /* pass */
    if (({ TrStr _aet_t3633 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("lld --version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3633.data) == 0LL)); _tr_str_release(_aet_t3633); _wr; })) {
        /* pass */
        _tr_str_release(null_dev);
        _tr_str_release(ext);
        _tr_str_release(bundled);
...
__attribute__((hot)) TrStr resolve_cross_driver(TrStr triple) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        TrStr _strtmp_t3634 = _tr_str_lit("nul");
        _tr_str_release(null_dev);
        null_dev = _strtmp_t3634;
    }
    /* pass */
    if (({ TrStr _aet_t3635 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(null_dev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3635.data) == 0LL)); _tr_str_release(_aet_t3635); _wr; })) {
        /* pass */
...
__attribute__((hot)) TrStr find_native_abi_c(TrStr input_path) {
    ...
    /* pass */
    if (({ TrStr _at_t3636 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3636)); _tr_str_release(_at_t3636); _wr; })) {
        /* pass */
        return _tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("native_abi.c")));
    }
    /* pass */
    if (({ TrStr _at_t3637 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3637)); _tr_str_release(_at_t3637); _wr; })) {
        /* pass */
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        /* pass */
        if (({ TrStr _at_t3638 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("native_abi.c")))); __auto_type _wr = (file_exists(_at_t3638)); _tr_str_release(_at_t3638); _wr; })) {
            /* pass */
        ...
        /* pass */
        if (({ TrStr _at_t3640 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3640)); _tr_str_release(_at_t3640); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
        ...
        /* pass */
        TrStr gp = ({ TrStr _at_t3641 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3641)); _tr_str_release(_at_t3641); _wr; });
        /* pass */
        if (({ TrStr _at_t3642 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/native_abi.c")))); __auto_type _wr = (file_exists(_at_t3642)); _tr_str_release(_at_t3642); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src_dir);
...
__attribute__((hot)) TrStr read_runtime_header(TrStr bin_path, TrStr input_path) {
    ...
    if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        TrStr src_dir = dir_of_path(input_path);
        /* pass */
        if (({ TrStr _at_t3643 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3643)); _tr_str_release(_at_t3643); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            return ({ TrStr _at_t3644 = (_tr_strx_concat(_tr_strz(src_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3644)); _tr_str_release(_at_t3644); _wr; });
        }
        /* pass */
        TrStr parent = ({ TrStr _at_t3645 = (strip_trailing_sep_inline(src_dir)); __auto_type _wr = (dir_of_path(_at_t3645)); _tr_str_release(_at_t3645); _wr; });
        /* pass */
        if (({ TrStr _at_t3646 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3646)); _tr_str_release(_at_t3646); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3647 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3647)); _tr_str_release(_at_t3647); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3648 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3648)); _tr_str_release(_at_t3648); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            return ({ TrStr _at_t3649 = (_tr_strx_concat(_tr_strz(parent), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3649)); _tr_str_release(_at_t3649); _wr; });
        }
        /* pass */
        TrStr gp = ({ TrStr _at_t3650 = (strip_trailing_sep_inline(parent)); __auto_type _wr = (dir_of_path(_at_t3650)); _tr_str_release(_at_t3650); _wr; });
        /* pass */
        if (({ TrStr _at_t3651 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3651)); _tr_str_release(_at_t3651); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3652 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("runtime/tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3652)); _tr_str_release(_at_t3652); _wr; });
        }
        /* pass */
        if (({ TrStr _at_t3653 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (file_exists(_at_t3653)); _tr_str_release(_at_t3653); _wr; })) {
            /* pass */
            _tr_str_release(bin_dir);
            _tr_str_release(src1);
            _tr_str_release(src1b);
            _tr_str_release(src_dir);
            _tr_str_release(parent);
            return ({ TrStr _at_t3654 = (_tr_strx_concat(_tr_strz(gp), _tr_strz(_tr_str_lit("tauraro_rt.h")))); __auto_type _wr = (read_file(_at_t3654)); _tr_str_release(_at_t3654); _wr; });
        }
        _tr_str_release(src_dir);
        _tr_str_release(parent);
    }
...
__attribute__((hot)) TrStr out_dir_prefix(TrStr out_dir) {
    ...
    if ((!(_tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("/"))) || _tr_str_ends_with(_tr_strz(d), _tr_strz(_tr_str_lit("\\")))))) {
        /* pass */
        TrStr _strtmp_t3655 = _tr_strx_concat(_tr_strz(d), _tr_strz(_tr_str_lit("/")));
        _tr_str_release(d);
        d = _strtmp_t3655;
    }
    /* pass */
...
__attribute__((hot)) TrStr resolve_output_stem(TrStr input_path, TrStr output_path, TrStr out_dir) {
    ...
    if (((strcmp(_tr_strz(output_path), _tr_strz(_tr_str_lit(""))) != 0) && has_path_sep(output_path))) {
        /* pass */
        ({ TrStr _at_t3656 = (dir_of_path(output_path)); make_dir(_at_t3656); _tr_str_release(_at_t3656); });
        /* pass */
    ...
    /* pass */
    return ({ TrStr _at_t3657 = (get_filename(input_path)); __auto_type _wr = (({ TrStr _cr = (strip_extension(_at_t3657)); TrStr _cres = _tr_strx_concat(_tr_strz(pref), _cr.data); _tr_str_release(_cr); _cres; })); _tr_str_release(_at_t3657); _wr; });
}
...
__attribute__((hot)) TrStr ensure_builtin_dirs(TrStr build_dir, TrStr dot_path) {
    ...
    while (true) {
        ...
        if ((c == 46LL)) {
            ...
            /* pass */
            TrStr _strtmp_t3658 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(current), _tr_strz(seg))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("/"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(current);
            current = _strtmp_t3658;
            /* pass */
            make_dir(current);
            /* pass */
            start = (i + 1LL);
...
__attribute__((hot)) void make_dir(TrStr path) {
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _aet_t3659 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(path)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("mkdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3659.data); _tr_str_release(_aet_t3659); });
    } else {
        /* pass */
        ({ TrStr _aet_t3660 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("mkdir -p \"")), _tr_strz(path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3660.data); _tr_str_release(_aet_t3660); });
    }
}
...
__attribute__((hot)) long long compile_all_c(List_TrStr* c_files, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        triple = _strtmp_t3661;
        /* pass */
        TrStr _strtmp_t3662 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3662;
        /* pass */
        TrStr _strtmp_t3663 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3663;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3664 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3664;
        }
    }
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3665 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3665;
    }
    /* pass */
    ...
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3666 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3666;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3667 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3667;
    }
    /* pass */
    ...
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3668 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3668;
    }
    /* pass */
    ...
    while ((i < c_files->len)) {
        /* pass */
        TrStr _strtmp_t3669 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(c_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3669;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3671 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3671;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3672 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3672;
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3673 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -fsanitize=address,undefined -g")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3673;
    }
    /* pass */
    if (out_is_windows(target, triple)) {
        ...
        if (need_wsa) {
            /* pass */
            TrStr _strtmp_t3674 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
            _tr_str_release(cmd);
            cmd = _strtmp_t3674;
        }
    }
...
__attribute__((hot)) long long compile_all_c_incremental(List_TrStr* c_files, List_bool* needs, TrStr exe_path, TrStr inc_dir, List_TrStr* link_paths, List_TrStr* lib_flags, TrStr opt_level, bool verbose, bool static_link, TrStr target, TrStr sysroot, bool debug_mode, bool build_shared, bool link_cxx, bool use_lto) {
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        _tr_str_release(triple);
        triple = _strtmp_t3675;
        /* pass */
        TrStr _strtmp_t3676 = resolve_cross_driver(triple);
        _tr_str_release(cc);
        cc = _strtmp_t3676;
        /* pass */
        TrStr _strtmp_t3677 = target_extra_flags(triple);
        _tr_str_release(cross_flags);
        cross_flags = _strtmp_t3677;
        /* pass */
        if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3678 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cross_flags), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
            _tr_str_release(cross_flags);
            cross_flags = _strtmp_t3678;
        }
    }
    /* pass */
    TrStr static_flag = _tr_str_lit("");
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3679 = _tr_str_lit(" -static");
        _tr_str_release(static_flag);
        static_flag = _strtmp_t3679;
    }
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3680 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3680;
    }
    /* pass */
    TrStr native_flags = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) == 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) == 0))) {
        /* pass */
        TrStr _strtmp_t3681 = _tr_str_lit(" -march=native -funroll-loops");
        _tr_str_release(native_flags);
        native_flags = _strtmp_t3681;
    }
    /* pass */
    TrStr overflow_flag = _tr_str_lit("");
    /* pass */
    if (((strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("3"))) != 0) && (strcmp(_tr_strz(opt_level), _tr_strz(_tr_str_lit("s"))) != 0))) {
        /* pass */
        TrStr _strtmp_t3682 = _tr_str_lit(" -ftrapv");
        _tr_str_release(overflow_flag);
        overflow_flag = _strtmp_t3682;
    }
    /* pass */
    ...
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3683 = _tr_str_lit(" -fsanitize=address,undefined -g");
        _tr_str_release(dbg);
        dbg = _strtmp_t3683;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3684 = _tr_str_lit(" -fPIC");
        _tr_str_release(pic);
        pic = _strtmp_t3684;
    }
    /* pass */
    ...
    if (use_lto) {
        /* pass */
        TrStr _strtmp_t3685 = _tr_str_lit(" -flto");
        _tr_str_release(lto_flag);
        lto_flag = _strtmp_t3685;
    }
    /* pass */
    ...
    if (build_shared) {
        /* pass */
        TrStr _strtmp_t3686 = _tr_str_lit(" -shared");
        _tr_str_release(shared_flag);
        shared_flag = _strtmp_t3686;
    }
    /* pass */
    ...
    if (link_cxx) {
        /* pass */
        TrStr _strtmp_t3687 = cxx_of(cc);
        _tr_str_release(link_driver);
        link_driver = _strtmp_t3687;
    }
    /* pass */
    ...
    while ((i < o_files->len)) {
        /* pass */
        TrStr _strtmp_t3688 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(o_files, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3688;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < link_paths->len)) {
        /* pass */
        TrStr _strtmp_t3689 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" \"")))); TrStr _cr = (List_TrStr_get(link_paths, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3689;
        /* pass */
        i = (i + 1LL);
    ...
    while ((i < lib_flags->len)) {
        /* pass */
        TrStr _strtmp_t3690 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" ")))); TrStr _cr = (List_TrStr_get(lib_flags, i)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        _tr_str_release(cmd);
        cmd = _strtmp_t3690;
        /* pass */
        i = (i + 1LL);
    ...
    /* pass */
    TrStr _strtmp_t3691 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lm")));
    _tr_str_release(cmd);
    cmd = _strtmp_t3691;
    /* pass */
    if (out_is_windows(target, triple)) {
        /* pass */
        TrStr _strtmp_t3692 = _tr_strx_concat(_tr_strz(cmd), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -mconsole")));
        _tr_str_release(cmd);
        cmd = _strtmp_t3692;
    }
    /* pass */
...
__attribute__((hot)) long long compile_c_to_exe(TrStr c_path, TrStr exe_path, TrStr opt_level, bool verbose) {
    ...
    /* pass */
    TrStr out_dir = ({ TrStr _at_t3693 = (dir_of_path(c_path)); __auto_type _wr = (strip_trailing_sep(_at_t3693)); _tr_str_release(_at_t3693); _wr; });
    /* pass */
    TrStr warn_flags = _tr_str_lit(" -Wno-string-compare -Wno-comment -Wno-attributes -Wno-unused-value");
    /* pass */
    if (is_clang_compiler(cc)) {
        /* pass */
        TrStr _strtmp_t3694 = _tr_strx_concat(_tr_strz(warn_flags), _tr_strz(_tr_str_lit(" -Wno-unknown-attributes -Wno-parentheses-equality")));
        _tr_str_release(warn_flags);
        warn_flags = _strtmp_t3694;
    }
    /* pass */
...
__attribute__((hot)) void _print_diag(TrStr level, TrStr msg) {
    ...
    if ((fix_idx >= 0LL)) {
        /* pass */
        TrStr _strtmp_t3696 = ({ TrStr _wt_t3695 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), 0LL, fix_idx))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3695.data))); _tr_str_release(_wt_t3695); _wr; });
        _tr_str_release(main_part);
        main_part = _strtmp_t3696;
        /* pass */
        TrStr _strtmp_t3698 = ({ TrStr _wt_t3697 = (_tr_str_wrap(_tr_str_slice(_tr_strz(msg), (fix_idx + 4LL), _tr_strlen(_tr_strz(msg))))); __auto_type _wr = (_tr_str_wrap(_tr_str_strip(_wt_t3697.data))); _tr_str_release(_wt_t3697); _wr; });
        _tr_str_release(fix_part);
        fix_part = _strtmp_t3698;
    }
    /* pass */
    ...
    if ((pe > 0LL)) {
        ...
        if ((ln > 0LL)) {
            /* pass */
            TrStr _strtmp_t3699 = _tr_str_retain(head);
            _tr_str_release(loc_str);
            loc_str = _strtmp_t3699;
            /* pass */
            TrStr _strtmp_t3700 = loc_file(head);
            _tr_str_release(file_path);
            file_path = _strtmp_t3700;
            /* pass */
            line_no = ln;
            /* pass */
            TrStr _strtmp_t3701 = _tr_str_wrap(_tr_str_slice(_tr_strz(main_part), (pe + 2LL), _tr_strlen(_tr_strz(main_part))));
    ...
    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
        /* pass */
        TrStr _strtmp_t3702 = c_yellow(level);
        _tr_str_release(lvl);
        lvl = _strtmp_t3702;
    }
    /* pass */
    ...
    if ((_tr_strlen(_tr_strz(loc_str)) > 0LL)) {
        ...
        if ((_tr_strlen(_tr_strz(file_path)) > 0LL)) {
            /* pass */
            TrStr _strtmp_t3703 = read_file(file_path);
            _tr_str_release(src);
            src = _strtmp_t3703;
        }
        /* pass */
        if ((_tr_strlen(_tr_strz(src)) > 0LL)) {
            ...
            if ((_tr_strlen(_tr_strz(srcline)) > 0LL)) {
                ...
                if ((col > 0LL)) {
                    ...
                    if ((strcmp(_tr_strz(level), _tr_strz(_tr_str_lit("warning"))) == 0)) {
                        /* pass */
                        TrStr _strtmp_t3704 = c_yellow(underline);
...
__attribute__((hot)) void cleanup_build(TrStr build_dir, List_TrStr* all_c_files) {
    ...
    while ((di < all_c_files->len)) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            ({ TrStr _at_t3705 = (List_TrStr_get(all_c_files, di)); TrStr _aet_t3706 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3705)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3706.data); _tr_str_release(_at_t3705); _tr_str_release(_aet_t3706); });
        } else {
            /* pass */
            ({ TrStr _aet_t3707 = (({ TrStr _cl = (({ TrStr _cr = (List_TrStr_get(all_c_files, di)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3707.data); _tr_str_release(_aet_t3707); });
        }
        /* pass */
        di = (di + 1LL);
    }
    ...
    if (_tr_is_windows()) {
        /* pass */
        ({ TrStr _at_t3708 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_types.h")))); TrStr _aet_t3709 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3708)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3709.data); _tr_str_release(_at_t3708); _tr_str_release(_aet_t3709); });
        /* pass */
        ({ TrStr _at_t3710 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); TrStr _aet_t3711 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3710)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("del /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3711.data); _tr_str_release(_at_t3710); _tr_str_release(_aet_t3711); });
        /* pass */
        ({ TrStr _at_t3712 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("include")))); TrStr _aet_t3713 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(_at_t3712)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir /S /Q \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3713.data); _tr_str_release(_at_t3712); _tr_str_release(_aet_t3713); });
        /* pass */
        ({ TrStr _aet_t3714 = (({ TrStr _cl = (({ TrStr _cr = (path_to_native(build_dir)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>nul >nul"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3714.data); _tr_str_release(_aet_t3714); });
    } else {
        /* pass */
        ({ TrStr _aet_t3715 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_types.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3715.data); _tr_str_release(_aet_t3715); });
        /* pass */
        ({ TrStr _aet_t3716 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -f \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("tauraro_rt.h\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3716.data); _tr_str_release(_aet_t3716); });
        /* pass */
        ({ TrStr _aet_t3717 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rm -rf \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3717.data); _tr_str_release(_aet_t3717); });
        /* pass */
        ({ TrStr _aet_t3718 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("rmdir \"")), _tr_strz(build_dir))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>/dev/null"))); _tr_str_release(_cl); _cres; })); _tr_system(_aet_t3718.data); _tr_str_release(_aet_t3718); });
    }
}
...
__attribute__((hot)) void run_fmt(TrStr path0, bool write_in_place) {
    ...
    if (((!file_exists(path)) && (!str_ends_with_dot_tr(path)))) {
        /* pass */
        TrStr _strtmp_t3719 = _tr_strx_concat(_tr_strz(path), _tr_strz(_tr_str_lit(".tr")));
...
__attribute__((hot)) int main(int argc, char** argv) {
    ...
    if ((args->len >= 2LL)) {
        ...
        if ((((strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("fmt"))) == 0) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("lint"))) == 0)) || (strcmp(_tr_strz(a1), _tr_strz(_tr_str_lit("bindgen"))) == 0))) {
            /* pass */
            TrStr _strtmp_t3720 = _tr_str_retain(a1);
            _tr_str_release(subcmd);
            subcmd = _strtmp_t3720;
        }
    }
    /* pass */
        ...
        while ((bk < args->len)) {
            ...
            if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--pkg"))) == 0) && ((bk + 1LL) < args->len))) {
                ...
                if ((strcmp(_tr_strz(pkgcf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3721 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkgcf)); _tr_str_release(_cl); _cres; });
                ...
                if ((strcmp(_tr_strz(pkglf), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3722 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_pkglibs), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pkglf)); _tr_str_release(_cl); _cres; });
                    _tr_str_release(bg_pkglibs);
                    bg_pkglibs = _strtmp_t3722;
                }
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-o"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3723 = List_TrStr_get(args, (bk + 1LL));
                _tr_str_release(bg_out);
                bg_out = _strtmp_t3723;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("--cc"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3724 = List_TrStr_get(args, (bk + 1LL));
                ...
                /* pass */
                TrStr _strtmp_t3725 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -I\"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3725;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-D"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3726 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -D")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3726;
                /* pass */
                bk = (bk + 1LL);
            } else if (((strcmp(_tr_strz(ba), _tr_strz(_tr_str_lit("-isystem"))) == 0) && ((bk + 1LL) < args->len))) {
                /* pass */
                TrStr _strtmp_t3727 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" -isystem \"")))); TrStr _cr = (List_TrStr_get(args, (bk + 1LL))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3727;
                /* pass */
                bk = (bk + 1LL);
                ...
                /* pass */
                TrStr _strtmp_t3728 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(bg_extra), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ba)); _tr_str_release(_cl); _cres; });
                _tr_str_release(bg_extra);
                bg_extra = _strtmp_t3728;
            } else if ((!str_starts_with(ba, _tr_str_lit("-")))) {
                /* pass */
                if ((strcmp(_tr_strz(bg_header), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3729 = _tr_str_retain(ba);
                    _tr_str_release(bg_header);
                    bg_header = _strtmp_t3729;
                }
            }
            /* pass */
            bk = (bk + 1LL);
        ...
        while ((fk < args->len)) {
            ...
            if (((strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("-w"))) == 0) || (strcmp(_tr_strz(fa), _tr_strz(_tr_str_lit("--write"))) == 0))) {
                ...
                if ((strcmp(_tr_strz(fpath), _tr_strz(_tr_str_lit(""))) == 0)) {
                    /* pass */
                    TrStr _strtmp_t3730 = _tr_str_retain(fa);
    ...
    while ((i < args->len)) {
        ...
        if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--version"))) == 0)) {
            ...
            backend = _strtmp_t3735;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-o"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3736 = List_TrStr_get(args, i);
            _tr_str_release(output_path);
            output_path = _strtmp_t3736;
        } else if ((((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-d"))) == 0) || (strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--dir"))) == 0)) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3737 = List_TrStr_get(args, i);
            _tr_str_release(out_dir);
            out_dir = _strtmp_t3737;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--link"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3738 = (List_TrStr_get(args, i)); List_TrStr_append(link_paths, _at_t3738); _tr_str_release(_at_t3738); });
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-l"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            ({ TrStr _at_t3739 = (({ TrStr _cr = (List_TrStr_get(args, i)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("-l")), _cr.data); _tr_str_release(_cr); _cres; })); List_TrStr_append(lib_flags, _at_t3739); _tr_str_release(_at_t3739); });
            ...
            /* pass */
            TrStr _strtmp_t3740 = _tr_str_lit("0");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3740;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O1"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3741 = _tr_str_lit("1");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3741;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O2"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3742 = _tr_str_lit("2");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3742;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-O3"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3743 = _tr_str_lit("3");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3743;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("-Os"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3744 = _tr_str_lit("s");
            _tr_str_release(opt_level);
            opt_level = _strtmp_t3744;
            ...
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3745 = List_TrStr_get(args, i);
            _tr_str_release(target);
            target = _strtmp_t3745;
        } else if (((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--sysroot"))) == 0) && ((i + 1LL) < args->len))) {
            /* pass */
            i = (i + 1LL);
            /* pass */
            TrStr _strtmp_t3746 = List_TrStr_get(args, i);
            _tr_str_release(sysroot);
            sysroot = _strtmp_t3746;
            ...
            /* pass */
            TrStr _strtmp_t3747 = _tr_str_lit("TAURARO_KERNEL");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3747;
        } else if ((strcmp(_tr_strz(arg), _tr_strz(_tr_str_lit("--no-std"))) == 0)) {
            /* pass */
            TrStr _strtmp_t3748 = _tr_str_lit("TAURARO_NO_OS");
            _tr_str_release(tier_define);
            tier_define = _strtmp_t3748;
            ...
            if ((strcmp(_tr_strz(input_path), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3749 = _tr_str_retain(arg);
                _tr_str_release(input_path);
                input_path = _strtmp_t3749;
            }
        }
        /* pass */
        i = (i + 1LL);
    ...
    if (((!file_exists(input_path)) && (!str_ends_with_dot_tr(input_path)))) {
        /* pass */
        TrStr _strtmp_t3750 = _tr_strx_concat(_tr_strz(input_path), _tr_strz(_tr_str_lit(".tr")));
        _tr_str_release(input_path);
        input_path = _strtmp_t3750;
    }
    /* pass */
    ...
    /* pass */
    TrStr bin_dir = ({ TrStr _at_t3751 = (_tr_str_wrap(_tr_exe_dir())); __auto_type _wr = (strip_trailing_sep_inline(_at_t3751)); _tr_str_release(_at_t3751); _wr; });
    /* pass */
    ModuleResolver_add_search_path(resolver, bin_dir);
    /* pass */
    ({ TrStr _at_t3752 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/std")))); ModuleResolver_add_search_path(resolver, _at_t3752); _tr_str_release(_at_t3752); });
    /* pass */
    ({ TrStr _at_t3753 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages")))); ModuleResolver_add_search_path(resolver, _at_t3753); _tr_str_release(_at_t3753); });
    /* pass */
    ({ TrStr _at_t3754 = (_tr_strx_concat(_tr_strz(bin_dir), _tr_strz(_tr_str_lit("/packages/sites")))); ModuleResolver_add_search_path(resolver, _at_t3754); _tr_str_release(_at_t3754); });
    /* pass */
    ...
    if ((strcmp(_tr_strz(tauraro_path_env), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        while ((epi < ep_count)) {
            /* pass */
            ({ TrStr _at_t3755 = (get_path_env_entry(tauraro_path_env, epi)); ModuleResolver_add_search_path(resolver, _at_t3755); _tr_str_release(_at_t3755); });
            /* pass */
            epi = (epi + 1LL);
        }
    }
    ...
    if ((sema->warnings->len > 0LL)) {
        ...
        while ((wk < sema->warnings->len)) {
            /* pass */
            ({ TrStr _at_t3756 = (List_TrStr_get(sema->warnings, wk)); _print_diag(_tr_str_lit("warning"), _at_t3756); _tr_str_release(_at_t3756); });
            /* pass */
            wk = (wk + 1LL);
        }
    }
    ...
    if ((sema->errors->len > 0LL)) {
        ...
        while ((k < sema->errors->len)) {
            /* pass */
            ({ TrStr _at_t3757 = (List_TrStr_get(sema->errors, k)); _print_diag(_tr_str_lit("error"), _at_t3757); _tr_str_release(_at_t3757); });
            /* pass */
            k = (k + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("gpu"))) == 0)) {
        ...
        if ((!gpu_gen->ok)) {
            /* pass */
            ({ TrStr _at_t3758 = (_tr_strx_concat(_tr_strz(_tr_str_lit("[GPU] ")), _tr_strz(gpu_gen->fail_note))); _print_diag(_tr_str_lit("error"), _at_t3758); _tr_str_release(_at_t3758); });
            /* pass */
            exit((int)(1LL));
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("llvm"))) == 0)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3759 = resolve_target_triple(target);
            _tr_str_release(lx_triple);
            lx_triple = _strtmp_t3759;
            /* pass */
            lx_is_cross = true;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            /* pass */
            TrStr _strtmp_t3760 = target_extra_flags(lx_triple);
            _tr_str_release(lx_tflags);
            lx_tflags = _strtmp_t3760;
        }
        /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3761 = _tr_str_lit("nul");
                _tr_str_release(lx_xnull);
                lx_xnull = _strtmp_t3761;
            }
            /* pass */
            if (({ TrStr _aet_t3762 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("zig version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3762.data) == 0LL)); _tr_str_release(_aet_t3762); _wr; })) {
                /* pass */
                TrStr lx_zt = zig_target_of(lx_triple);
                /* pass */
                if ((strcmp(_tr_strz(lx_zt), _tr_strz(_tr_str_lit(""))) != 0)) {
                    /* pass */
                    TrStr _strtmp_t3763 = _tr_strx_concat(_tr_strz(_tr_str_lit("zig cc -target ")), _tr_strz(lx_zt));
                    _tr_str_release(lx_xcc);
                    lx_xcc = _strtmp_t3763;
                    /* pass */
                    lx_via_zig = true;
                }
            }
            /* pass */
            if (({ TrStr _aet_t3764 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_xnull))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((strcmp(_tr_strz(lx_xcc), _tr_strz(_tr_str_lit(""))) == 0) && (_tr_system(_aet_t3764.data) == 0LL))); _tr_str_release(_aet_t3764); _wr; })) {
                /* pass */
                TrStr _strtmp_t3765 = _tr_strx_concat(_tr_strz(_tr_str_lit("clang --target=")), _tr_strz(lx_triple));
                _tr_str_release(lx_xcc);
                lx_xcc = _strtmp_t3765;
            }
            /* pass */
        ...
        if (lx_is_cross) {
            ...
            if (_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) {
                /* pass */
                TrStr _strtmp_t3766 = _tr_str_lit(".wasm");
                _tr_str_release(lx_ext);
                lx_ext = _strtmp_t3766;
                ...
                /* pass */
                TrStr _strtmp_t3767 = _tr_str_lit(".exe");
                _tr_str_release(lx_ext);
                lx_ext = _strtmp_t3767;
            }
        } else if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3768 = _tr_str_lit(".exe");
            _tr_str_release(lx_ext);
            lx_ext = _strtmp_t3768;
        }
        /* pass */
        TrStr lx_exe = ({ TrStr _at_t3769 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3769, lx_ext)); _tr_str_release(_at_t3769); _wr; });
        /* pass */
        ...
        if (((lx_is_cross && _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && _tr_str_contains(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("define i32 @main()"))))) {
            /* pass */
            TrStr _strtmp_t3770 = _tr_strx_concat(_tr_strz(llvm_ir), _tr_strz(_tr_str_lit("\n@__main_void = hidden alias i32 (), ptr @main\n")));
            _tr_str_release(llvm_ir);
            llvm_ir = _strtmp_t3770;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3775 = _tr_str_lit("nul");
            _tr_str_release(lx_null);
            lx_null = _strtmp_t3775;
        }
        /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3776 = _tr_strx_concat(_tr_strz(lx_libs), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt -lucrtbase -mconsole")));
            _tr_str_release(lx_libs);
            lx_libs = _strtmp_t3776;
            /* pass */
            TrStr _strtmp_t3777 = _tr_strx_concat(_tr_strz(lx_libs_gcc), _tr_strz(_tr_str_lit(" -lws2_32 -lbcrypt")));
            _tr_str_release(lx_libs_gcc);
            lx_libs_gcc = _strtmp_t3777;
        }
        /* pass */
        bool lx_built = false;
        /* pass */
        if (lx_is_cross) {
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3778 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_cg);
                lx_cg = _strtmp_t3778;
            }
            /* pass */
            if (({ TrStr _aet_t3779 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cg), _tr_strz(_tr_str_lit(" -c \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3779.data) != 0LL)); _tr_str_release(_aet_t3779); _wr; })) {
                /* pass */
            ...
            if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm"))) || _tr_str_contains(_tr_strz(lx_tflags), _tr_strz(_tr_str_lit("nostdlib"))))) {
                /* pass */
                TrStr _strtmp_t3780 = _tr_str_lit("");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3780;
            } else if ((_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("windows"))) || _tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("mingw"))))) {
                /* pass */
                TrStr _strtmp_t3781 = _tr_str_lit(" -lm -lws2_32 -lbcrypt -mconsole");
                _tr_str_release(lx_xlibs);
                lx_xlibs = _strtmp_t3781;
            }
            /* pass */
            ...
            if (((!_tr_str_contains(_tr_strz(lx_triple), _tr_strz(_tr_str_lit("wasm")))) && (!lx_via_zig))) {
                /* pass */
                TrStr _strtmp_t3782 = detect_lld_flag();
                _tr_str_release(lx_xld);
                lx_xld = _strtmp_t3782;
            }
            /* pass */
            ...
            if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
                /* pass */
                TrStr _strtmp_t3783 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" --sysroot=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(lx_xlink);
                lx_xlink = _strtmp_t3783;
            }
            /* pass */
            TrStr _strtmp_t3784 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_xlink), _tr_strz(_tr_str_lit(" ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xobj)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xlibs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_xld)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(lx_xlink);
            lx_xlink = _strtmp_t3784;
            /* pass */
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3785 = _tr_str_lit("x86_64-pc-windows-gnu");
            _tr_str_release(lx_tri);
            lx_tri = _strtmp_t3785;
        }
        /* pass */
        ...
        /* pass */
        if (({ TrStr _aet_t3787 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("clang --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3787.data) == 0LL))); _tr_str_release(_aet_t3787); _wr; })) {
            /* pass */
        ...
        /* pass */
        if (({ TrStr _aet_t3788 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc --version >")), _tr_strz(lx_null))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" 2>&1"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (((!lx_built) && (_tr_system(_aet_t3788.data) == 0LL))); _tr_str_release(_aet_t3788); _wr; })) {
            /* pass */
            TrStr lx_llc_tri = _tr_str_lit("");
            /* pass */
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3789 = _tr_str_lit(" -mtriple=x86_64-pc-windows-gnu");
                _tr_str_release(lx_llc_tri);
                lx_llc_tri = _strtmp_t3789;
            }
            /* pass */
            if (({ TrStr _aet_t3790 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -O2 -filetype=obj")), _tr_strz(lx_llc_tri))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_ll)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o build/llvm_out.o 2>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3790.data) == 0LL)); _tr_str_release(_aet_t3790); _wr; })) {
                /* pass */
                if (({ TrStr _aet_t3791 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(lx_cc), _tr_strz(_tr_str_lit(" build/llvm_out.o ")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_rto)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_libs_gcc)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(lx_exe)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>>build/llvm_link.log"))); _tr_str_release(_cl); _cres; })); __auto_type _wr = ((_tr_system(_aet_t3791.data) == 0LL)); _tr_str_release(_aet_t3791); _wr; })) {
                    /* pass */
                    lx_built = true;
                }
            }
        ...
        if (run_after) {
            ...
            if (_tr_is_windows()) {
                /* pass */
                TrStr _strtmp_t3795 = path_to_native(lx_run);
                _tr_str_release(lx_run);
                lx_run = _strtmp_t3795;
            }
            /* pass */
            ({ TrStr _aet_t3796 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(lx_run))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); exit((int)(_tr_system(_aet_t3796.data))); _tr_str_release(_aet_t3796); });
        }
        /* pass */
        _tr_str_release(subcmd);
        _tr_str_release(input_path);
    ...
    if ((strcmp(_tr_strz(backend), _tr_strz(_tr_str_lit("native"))) == 0)) {
        ...
        /* pass */
        TrStr nat_out = ({ TrStr _at_t3797 = (resolve_output_stem(input_path, output_path, out_dir)); __auto_type _wr = (ensure_ext(_at_t3797, _tr_str_lit(".o"))); _tr_str_release(_at_t3797); _wr; });
        /* pass */
    ...
    /* pass */
    TrStr rt_h = ({ TrStr _at_t3798 = (List_TrStr_get(args, 0LL)); __auto_type _wr = (read_runtime_header(_at_t3798, input_path)); _tr_str_release(_at_t3798); _wr; });
    /* pass */
    ...
    /* pass */
    TrStr _strtmp_t3799 = ({ TrStr _cr = (CGenerator_generate_module_compat(c_gen, resolver->all_decl_modules, resolver->all_decls)); TrStr _cres = _tr_strx_concat(_tr_strz(types_h), _cr.data); _tr_str_release(_cr); _cres; });
    _tr_str_release(types_h);
    types_h = _strtmp_t3799;
    /* pass */
    ...
    if (static_link) {
        /* pass */
        TrStr _strtmp_t3800 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";static")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3800;
    }
    /* pass */
    if (debug_mode) {
        /* pass */
        TrStr _strtmp_t3801 = _tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";debug")));
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3801;
    }
    /* pass */
    if ((strcmp(_tr_strz(sysroot), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3802 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(flags_sig), _tr_strz(_tr_str_lit(";sysroot=")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(sysroot)); _tr_str_release(_cl); _cres; });
        _tr_str_release(flags_sig);
        flags_sig = _strtmp_t3802;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(rt_h), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        ({ TrStr _at_t3803 = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("tauraro_rt.h")))); write_file(_at_t3803, rt_h); _tr_str_release(_at_t3803); });
    }
    /* pass */
    ...
    while ((mi < resolver->mod_dot_paths->len)) {
        ...
        while ((k < resolver->all_decl_modules->len)) {
            ...
            if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k)), _tr_strz(dot_path)) == 0)) {
                /* pass */
                __auto_type _t3804 = (*((Decl*)List_ptr_get(resolver->all_decls, k)));
                if (_t3804.tag == Decl_DClass) {
                    __auto_type c = _t3804.data.DClass.cls;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(c->name), true);
                } else if (_t3804.tag == Decl_DFunction) {
                    __auto_type f = _t3804.data.DFunction.func;
                    /* pass */
                    _tr_dict_set(fn_set, _tr_strz(f->name), true);
                    _tr_obj_release(f, _trdrop_FunctionDef);
                } else if (_t3804.tag == Decl_DEnum) {
                    __auto_type e = _t3804.data.DEnum.enm;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(e->name), true);
                } else if (_t3804.tag == Decl_DInterface) {
                    __auto_type iface = _t3804.data.DInterface.iface;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(iface->name), true);
                } else if (_t3804.tag == Decl_DExtend) {
                    __auto_type target = _t3804.data.DExtend.target;
__auto_type methods = _t3804.data.DExtend.methods;
                    /* pass */
                    _tr_dict_set(class_set, _tr_strz(target), true);
                    _tr_str_release(target);
                } else if (1) {
                    __auto_type _ = _t3804;
                    /* pass */
                }
            }
            /* pass */
        ...
        if (is_builtin_mod(dot_path)) {
            /* pass */
            TrStr _strtmp_t3805 = ensure_builtin_dirs(build_dir, dot_path);
            _tr_str_release(c_path);
            c_path = _strtmp_t3805;
            /* pass */
            depth = get_dot_depth(dot_path);
        } else {
            /* pass */
            TrStr _strtmp_t3806 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(build_dir), _tr_strz(_tr_str_lit("module_")))); TrStr _cr = (dot_to_safe(dot_path)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".c"))); _tr_str_release(_cl); _cres; });
            _tr_str_release(c_path);
            c_path = _strtmp_t3806;
            /* pass */
            depth = 0LL;
        }
        /* pass */
        if ((c_gen->emit_line_info && (mi < resolver->mod_file_paths->len))) {
            /* pass */
            c_gen->cur_src_file = ({ TrStr _at_t3807 = (List_TrStr_get(resolver->mod_file_paths, mi)); __auto_type _wr = (to_fwd_slashes(_at_t3807)); _tr_str_release(_at_t3807); _wr; });
        }
        /* pass */
    ...
    while ((k2 < resolver->all_decl_modules->len)) {
        ...
        if ((strcmp(_tr_strz(List_TrStr_get(resolver->all_decl_modules, k2)), _tr_strz(_tr_str_lit(""))) == 0)) {
            /* pass */
            __auto_type _t3808 = (*((Decl*)List_ptr_get(resolver->all_decls, k2)));
            if (_t3808.tag == Decl_DClass) {
                __auto_type c = _t3808.data.DClass.cls;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(c->name), true);
            } else if (_t3808.tag == Decl_DFunction) {
                __auto_type f = _t3808.data.DFunction.func;
                /* pass */
                _tr_dict_set(main_fn_set, _tr_strz(f->name), true);
                _tr_obj_release(f, _trdrop_FunctionDef);
            } else if (_t3808.tag == Decl_DEnum) {
                __auto_type e = _t3808.data.DEnum.enm;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(e->name), true);
            } else if (_t3808.tag == Decl_DInterface) {
                __auto_type iface = _t3808.data.DInterface.iface;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(iface->name), true);
            } else if (_t3808.tag == Decl_DExtend) {
                __auto_type target = _t3808.data.DExtend.target;
__auto_type methods = _t3808.data.DExtend.methods;
                /* pass */
                _tr_dict_set(main_class_set, _tr_strz(target), true);
                _tr_str_release(target);
            } else if (1) {
                __auto_type _ = _t3808;
                /* pass */
            }
        }
        /* pass */
    ...
    if (export_cpp) {
        /* pass */
        TrStr _strtmp_t3809 = ({ TrStr _cr = (CppExporter_generate_cpp_class_bridges(cpp_exporter, hir)); TrStr _cres = _tr_strx_concat(_tr_strz(main_c), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(main_c);
        main_c = _strtmp_t3809;
    }
    /* pass */
    ...
    if ((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            ({ TrStr _at_t3810 = (linker_script_riscv()); write_file(emit_ld, _at_t3810); _tr_str_release(_at_t3810); });
        } else {
            /* pass */
            ({ TrStr _at_t3811 = (linker_script_cortex_m()); write_file(emit_ld, _at_t3811); _tr_str_release(_at_t3811); });
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(emit_mode), _tr_strz(_tr_str_lit("c"))) == 0)) {
        ...
        while ((pi < (all_c_files->len - 1LL))) {
            /* pass */
            ({ TrStr _at_t3812 = (List_TrStr_get(all_c_files, pi)); ({ printf("%s", _tr_strz(({ TrStr _cr = (get_filename(_at_t3812)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("  ")), _cr.data); _tr_str_release(_cr); _cres; }))); printf("\n"); }); _tr_str_release(_at_t3812); });
            /* pass */
            pi = (pi + 1LL);
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(exe_name), _tr_strz(_tr_str_lit(""))) == 0)) {
        /* pass */
        TrStr _strtmp_t3813 = _tr_str_lit("a");
        _tr_str_release(exe_name);
        exe_name = _strtmp_t3813;
    }
    /* pass */
            ...
            if ((((long long)((*(en_p + (en_len - 3LL))))) == 101LL)) {
                ...
                if ((((long long)((*(en_p + (en_len - 2LL))))) == 120LL)) {
                    ...
                    if ((((long long)((*(en_p + (en_len - 1LL))))) == 101LL)) {
                        /* pass */
                        TrStr _strtmp_t3814 = _tr_str_wrap(_tr_str_slice(_tr_strz(exe_name), 0LL, (en_len - 4LL)));
                        _tr_str_release(exe_name);
                        exe_name = _strtmp_t3814;
                    }
                }
            }
        }
    ...
    if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
        /* pass */
        TrStr _strtmp_t3815 = resolve_target_triple(target);
        _tr_str_release(tgt_triple);
        tgt_triple = _strtmp_t3815;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (out_win) {
            /* pass */
            TrStr _strtmp_t3816 = _tr_str_lit(".dll");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3816;
        } else {
            /* pass */
            TrStr _strtmp_t3817 = _tr_str_lit(".so");
            _tr_str_release(exe_ext);
            exe_ext = _strtmp_t3817;
        }
    } else if (out_win) {
        /* pass */
        TrStr _strtmp_t3818 = _tr_str_lit(".exe");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3818;
    } else if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0) && _tr_str_contains(_tr_strz(tgt_triple), _tr_strz(_tr_str_lit("wasm"))))) {
        /* pass */
        TrStr _strtmp_t3819 = _tr_str_lit(".wasm");
        _tr_str_release(exe_ext);
        exe_ext = _strtmp_t3819;
    }
    /* pass */
    ...
    if (lib_mode) {
        ...
        if (export_cpp) {
            ...
            if ((strcmp(_tr_strz(ns), _tr_strz(_tr_str_lit(""))) == 0)) {
                /* pass */
                TrStr _strtmp_t3820 = _tr_str_lit("tauraro");
                _tr_str_release(ns);
                ns = _strtmp_t3820;
            }
            /* pass */
    ...
    if (((strcmp(_tr_strz(emit_ld), _tr_strz(_tr_str_lit(""))) != 0) && (!lib_mode))) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3822 = ({ TrStr _at_t3821 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3821)); _tr_str_release(_at_t3821); _wr; });
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t3823 = _tr_str_lit(" -mcpu=cortex_m3 -mthumb");
            _tr_str_release(bm_arch);
            bm_arch = _strtmp_t3823;
        }
        /* pass */
        if (_tr_str_contains(_tr_strz(target), _tr_strz(_tr_str_lit("riscv")))) {
            /* pass */
            TrStr _strtmp_t3824 = _tr_str_lit(" -march=rv64imac -mabi=lp64 -mcmodel=medany");
            _tr_str_release(bm_arch);
            bm_arch = _strtmp_t3824;
        }
        /* pass */
        ...
        if ((!bm_is_zig)) {
            /* pass */
            TrStr _strtmp_t3825 = detect_lld_flag();
            _tr_str_release(bm_lld);
            bm_lld = _strtmp_t3825;
        }
        /* pass */
        ...
        if (bm_is_zig) {
            /* pass */
            TrStr _strtmp_t3826 = _tr_str_lit(" -nostartfiles");
            _tr_str_release(bm_nostdlib);
            bm_nostdlib = _strtmp_t3826;
            /* pass */
            TrStr _strtmp_t3827 = _tr_str_lit(" -fno-sanitize=undefined");
            _tr_str_release(bm_ubsan);
            bm_ubsan = _strtmp_t3827;
            /* pass */
            TrStr _strtmp_t3828 = _tr_str_lit("");
            _tr_str_release(bm_libgcc);
            bm_libgcc = _strtmp_t3828;
        }
        /* pass */
    ...
    if (((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit("uefi-x64"))) == 0) && (!lib_mode))) {
        ...
        if (uefi_is_frame) {
            /* pass */
            TrStr _strtmp_t3832 = _tr_str_lit("tauraro_uefi_frame");
            _tr_str_release(uefi_entry);
            uefi_entry = _strtmp_t3832;
        } else if (hir_has_export_fn(hir, _tr_str_lit("tauraro_uefi_main"))) {
            /* pass */
            TrStr _strtmp_t3833 = _tr_str_lit("tauraro_uefi_main");
            _tr_str_release(uefi_entry);
            uefi_entry = _strtmp_t3833;
        } else if (hir_has_export_fn(hir, _tr_str_lit("tauraro_ui_render"))) {
            /* pass */
            TrStr _strtmp_t3834 = _tr_str_lit("tauraro_ui_render");
            _tr_str_release(uefi_entry);
            uefi_entry = _strtmp_t3834;
        }
        /* pass */
        ...
        if (uefi_is_frame) {
            /* pass */
            TrStr _strtmp_t3835 = uefi_zig_stub_frame(uefi_entry, uefi_has_heap_init, 64LL);
            _tr_str_release(uefi_stub_src);
            uefi_stub_src = _strtmp_t3835;
        } else {
            /* pass */
            TrStr _strtmp_t3836 = uefi_zig_stub(uefi_entry, uefi_has_heap_init, 16LL);
            _tr_str_release(uefi_stub_src);
            uefi_stub_src = _strtmp_t3836;
        }
        /* pass */
        ...
        /* pass */
        TrStr _strtmp_t3837 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -I \"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -I \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(build_dir)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("include\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3837;
        /* pass */
        TrStr _strtmp_t3838 = _tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -cflags -U_WIN32 -U_WIN64 -U_MSC_VER -- ")));
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3838;
        /* pass */
        long long uci = 0LL;
        /* pass */
        while ((uci < all_c_files->len)) {
            /* pass */
            TrStr _strtmp_t3839 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit("\"")))); TrStr _cr = (List_TrStr_get(all_c_files, uci)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" "))); _tr_str_release(_cl); _cres; });
            _tr_str_release(uefi_cmd);
            uefi_cmd = _strtmp_t3839;
            /* pass */
            uci = (uci + 1LL);
        }
        /* pass */
        TrStr _strtmp_t3840 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit("\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(uefi_stub_path)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3840;
        /* pass */
        TrStr _strtmp_t3841 = ({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(uefi_cmd), _tr_strz(_tr_str_lit(" -fno-strip -femit-bin=\"")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(uefi_efi)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" 2>build/uefi_link.log"))); _tr_str_release(_cl); _cres; });
        _tr_str_release(uefi_cmd);
        uefi_cmd = _strtmp_t3841;
        /* pass */
        if (verbose) {
            /* pass */
    ...
    if ((!no_auto_cpp)) {
        ...
        if ((strcmp(_tr_strz(target), _tr_strz(_tr_str_lit(""))) != 0)) {
            /* pass */
            TrStr _strtmp_t3843 = ({ TrStr _at_t3842 = (resolve_target_triple(target)); __auto_type _wr = (resolve_cross_driver(_at_t3842)); _tr_str_release(_at_t3842); _wr; });
            _tr_str_release(cc0);
            cc0 = _strtmp_t3843;
        }
        /* pass */
    ...
    if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit(""))) != 0)) {
        ...
        if ((gpu_gen->ok && (gpu_gen->n_kernels > 0LL))) {
            ...
            if ((strcmp(_tr_strz(gpu_embed), _tr_strz(_tr_str_lit("nvptx"))) == 0)) {
                /* pass */
                TrStr _strtmp_t3844 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=nvptx64-nvidia-cuda -mcpu=sm_50 \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3844;
            } else {
                /* pass */
                TrStr _strtmp_t3845 = ({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("llc -mtriple=spirv64-unknown-unknown -filetype=obj \"")), _tr_strz(ll_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\" -o \""))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(gbin)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; });
                _tr_str_release(llc_cmd);
                llc_cmd = _strtmp_t3845;
            }
            /* pass */
    ...
    if (run_after) {
        ...
        if (_tr_is_windows()) {
            /* pass */
            TrStr _strtmp_t3846 = path_to_native(run_path);
            _tr_str_release(run_path);
            run_path = _strtmp_t3846;
        }
        /* pass */
        long long run_rc = ({ TrStr _aet_t3847 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("\"")), _tr_strz(run_path))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\""))); _tr_str_release(_cl); _cres; })); __auto_type _wr = (_tr_system(_aet_t3847.data)); _tr_str_release(_aet_t3847); _wr; });
        /* pass */
        exit((int)(run_rc));
    }
    _tr_str_release(subcmd);
