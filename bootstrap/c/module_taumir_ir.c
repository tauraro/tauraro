...
__attribute__((hot)) void LFunc_set_term(LFunc* self, LTerm t) {
    ...
    /* pass */
    __auto_type _t2989 = b->term;
    if (_t2989.tag == LTerm_TUnset) {
        b->term = t;
    } else if (1) {
...
__attribute__((hot)) bool LFunc_cur_terminated(LFunc* self) {
    /* pass */
    __auto_type _t2990 = ((LBlock*)List_ptr_get(self->blocks, self->cur))->term;
    if (_t2990.tag == LTerm_TUnset) {
        return false;
    } else if (1) {
...
__attribute__((hot)) TrStr LModule_resolve_method_ov(LModule* self, TrStr cls, TrStr method, long long argc) {
    ...
    while ((depth < 32LL)) {
        ...
        /* pass */
        TrStr _strtmp_t2991 = _tr_str_retain(((ClassLayout*)List_ptr_get(self->classes, ci))->base);
        _tr_str_release(cur);
        cur = _strtmp_t2991;
        /* pass */
...
__attribute__((hot)) TrStr LModule_resolve_method(LModule* self, TrStr cls, TrStr method) {
    ...
    while ((depth < 32LL)) {
        ...
        /* pass */
        TrStr _strtmp_t2992 = _tr_str_retain(((ClassLayout*)List_ptr_get(self->classes, ci))->base);
        _tr_str_release(cur);
        cur = _strtmp_t2992;
        /* pass */
        if (((((unsigned long long)(((char*)(_tr_strz(cur))))) == ((unsigned long long)(0LL))) || (strcmp(_tr_strz(cur), _tr_strz(_tr_str_lit(""))) == 0))) {
