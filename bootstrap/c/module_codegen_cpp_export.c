...
__attribute__((malloc,returns_nonnull,hot)) CppExporter* CppExporter_init(CGenerator* gen) {
    ...
    /* pass */
    CGenerator* _cltmp_t2844 = _tr_obj_retain(gen);
...
__attribute__((hot)) TrStr CppExporter__cpp_list_sfx(CppExporter* self, AstType* ty) {
    /* pass */
    return ({ TrStr _at_t2845 = (CGenerator_list_elem_suffix(self->gen, (*((AstType**)List_ptr_get(ty->args, 0LL)))->name)); __auto_type _wr = (CGenerator_list_sfx(self->gen, _at_t2845)); _tr_str_release(_at_t2845); _wr; });
}
...
__attribute__((hot)) TrStr CppExporter__cpp_dict_v_cpp(CppExporter* self, AstType* ty) {
    /* pass */
    return ({ TrStr _at_t2846 = (CppExporter__cpp_dict_vkind(self, ty)); __auto_type _wr = (CppExporter__cpp_slot_cpp(self, _at_t2846)); _tr_str_release(_at_t2846); _wr; });
}
...
__attribute__((hot)) TrStr CppExporter__cpp_tuple_elem_cpp(CppExporter* self, AstType* ty, long long i) {
    /* pass */
    return ({ TrStr _at_t2847 = (CppExporter__cpp_slot_kind(self, (*((AstType**)List_ptr_get(ty->args, i)))->name)); __auto_type _wr = (CppExporter__cpp_slot_cpp(self, _at_t2847)); _tr_str_release(_at_t2847); _wr; });
}
...
__attribute__((hot)) void CppExporter__note_export_ty(CppExporter* self, AstType* ty) {
    ...
    if (((strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("List"))) == 0) || (strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Vec"))) == 0))) {
        ...
        if (CppExporter__cpp_list_ok(self, ty)) {
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_list_elem_kind(self, ty)), _tr_strz(_tr_str_lit("class"))) == 0)) {
                ...
                /* pass */
                ({ TrStr _dkt_t2848 = (CppExporter__cpp_list_sfx(self, ty)); TrStr _dvt_t2849 = (CppExporter__cpp_list_elem_c(self, ty)); _tr_dict_set(self->list_elems, _tr_strz(_dkt_t2848), _tr_str_box(_tr_str_retain(_dvt_t2849))); _tr_str_release(_dkt_t2848); _tr_str_release(_dvt_t2849); });
            }
        }
    }
    /* pass */
    if ((((strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Dict"))) == 0) || (strcmp(_tr_strz(n), _tr_strz(_tr_str_lit("Map"))) == 0)) && CppExporter__cpp_dict_ok(self, ty))) {
        /* pass */
        ({ TrStr _dkt_t2850 = (CppExporter__cpp_dict_variant(self, ty)); TrStr _at_t2851 = (CppExporter__cpp_dict_vkind(self, ty)); TrStr _dvt_t2852 = (CppExporter__cpp_slot_c(self, _at_t2851)); _tr_dict_set(self->dict_variants, _tr_strz(_dkt_t2850), _tr_str_box(_tr_str_retain(_dvt_t2852))); _tr_str_release(_dkt_t2850); _tr_str_release(_at_t2851); _tr_str_release(_dvt_t2852); });
        /* pass */
...
__attribute__((hot)) bool CppExporter__cpp_fn_needs_bridge(CppExporter* self, HirFunction* f) {
    /* pass */
    if (({ TrStr _at_t2853 = (CppExporter__cpp_ty_kind(self, f->ret_ty)); __auto_type _wr = (CppExporter__cpp_kind_bridged(self, _at_t2853)); _tr_str_release(_at_t2853); _wr; })) {
        /* pass */
        return true;
    }
    /* pass */
    ...
    while ((i < f->params->len)) {
        /* pass */
        if (({ TrStr _at_t2854 = (CppExporter__cpp_ty_kind(self, ((HirParam*)List_ptr_get(f->params, i))->ty)); __auto_type _wr = (CppExporter__cpp_kind_bridged(self, _at_t2854)); _tr_str_release(_at_t2854); _wr; })) {
            /* pass */
            return true;
        }
        /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_tuple_type_cpp(CppExporter* self, AstType* ty) {
    ...
    while ((i < ty->args->len)) {
        ...
        if ((i > 0LL)) {
            /* pass */
            TrStr _strtmp_t2855 = _tr_strx_concat(_tr_strz(s), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(s);
            s = _strtmp_t2855;
        }
        /* pass */
        TrStr _strtmp_t2856 = ({ TrStr _cr = (CppExporter__cpp_tuple_elem_cpp(self, ty, i)); TrStr _cres = _tr_strx_concat(_tr_strz(s), _cr.data); _tr_str_release(_cr); _cres; });
        _tr_str_release(s);
        s = _strtmp_t2856;
        /* pass */
        i = (i + 1LL);
...
__attribute__((hot)) bool CppExporter__cpp_fn_has_list(CppExporter* self, HirFunction* f) {
    /* pass */
    if (({ TrStr _at_t2857 = (CppExporter__cpp_ty_kind(self, f->ret_ty)); __auto_type _wr = (CppExporter__cpp_kind_marshal(self, _at_t2857)); _tr_str_release(_at_t2857); _wr; })) {
        /* pass */
        return true;
    }
    /* pass */
    ...
    while ((i < f->params->len)) {
        /* pass */
        if (({ TrStr _at_t2858 = (CppExporter__cpp_ty_kind(self, ((HirParam*)List_ptr_get(f->params, i))->ty)); __auto_type _wr = (CppExporter__cpp_kind_marshal(self, _at_t2858)); _tr_str_release(_at_t2858); _wr; })) {
            /* pass */
            return true;
        }
        /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_wrap_fn(CppExporter* self, HirFunction* f) {
    ...
    if (CppExporter__cpp_fn_needs_bridge(self, f)) {
        /* pass */
        TrStr _strtmp_t2859 = _tr_strx_concat(_tr_strz(_tr_str_lit("tr__")), _tr_strz(f->name));
        _tr_str_release(target);
        target = _strtmp_t2859;
    }
    /* pass */
    StringBuilder* wb = StringBuilder_init(256LL);
    /* pass */
    ({ TrStr _sbt_t2860 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_type(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("    inline ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2860); _tr_str_release(_sbt_t2860); });
    /* pass */
    long long i = 0LL;
    /* pass */
    while ((i < f->params->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t2861 = (CppExporter__cpp_param_decl(self, p->ty, pn)); StringBuilder_append(wb, _sbt_t2861); _tr_str_release(_sbt_t2861); });
        /* pass */
        i = (i + 1LL);
    }
    /* pass */
    if ((!CppExporter__cpp_fn_has_list(self, f))) {
        ...
        while ((i < f->params->len)) {
            ...
            if ((i > 0LL)) {
                /* pass */
                TrStr _strtmp_t2862 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(call_args);
                call_args = _strtmp_t2862;
            }
            /* pass */
            TrStr _strtmp_t2863 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p2->ty, pn2)); TrStr _cres = _tr_strx_concat(_tr_strz(call_args), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(call_args);
            call_args = _strtmp_t2863;
            /* pass */
            i = (i + 1LL);
        }
        /* pass */
        ({ TrStr _at_t2864 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(target), _tr_strz(_tr_str_lit("(")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call_args)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t2865 = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_stmt(self, f->ret_ty, _at_t2864)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(") { ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2865); _tr_str_release(_at_t2864); _tr_str_release(_sbt_t2865); });
        /* pass */
        _tr_str_release(target);
        _tr_str_release(call_args);
    ...
    while ((i < f->params->len)) {
        ...
        if ((i > 0LL)) {
            /* pass */
            TrStr _strtmp_t2866 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(_tr_str_lit(", ")));
            _tr_str_release(call_args);
            call_args = _strtmp_t2866;
        }
        /* pass */
        ...
        if ((strcmp(_tr_strz(pk), _tr_strz(_tr_str_lit("list"))) == 0)) {
            ...
            if ((strcmp(_tr_strz((*((AstType**)List_ptr_get(p3->ty->args, 0LL)))->name), _tr_strz(_tr_str_lit("str"))) == 0)) {
                /* pass */
                TrStr _strtmp_t2867 = _tr_str_lit("TrStr{ (char*)_e.c_str(), (long*)0 }");
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_dict_kkind(self, p3->ty)), _tr_strz(_tr_str_lit("s"))) == 0)) {
                /* pass */
                TrStr _strtmp_t2872 = _tr_str_lit("TrStr{ (char*)_kv.first.c_str(), (long*)0 }");
            ...
            /* pass */
            ({ TrStr _sbt_t2878 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        TrTuple ")), _tr_strz(tmp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = {};\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2878); _tr_str_release(_sbt_t2878); });
            /* pass */
            long long ti = 0LL;
            /* pass */
            ...
            /* pass */
            TrStr _strtmp_t2882 = _tr_strx_concat(_tr_strz(call_args), _tr_strz(tmp));
            _tr_str_release(call_args);
            call_args = _strtmp_t2882;
            _tr_str_release(tmp);
        } else {
            /* pass */
            TrStr _strtmp_t2883 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p3->ty, pn3)); TrStr _cres = _tr_strx_concat(_tr_strz(call_args), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(call_args);
            call_args = _strtmp_t2883;
        }
        /* pass */
        i = (i + 1LL);
        _tr_str_release(pk);
    ...
    if ((strcmp(_tr_strz(rk), _tr_strz(_tr_str_lit("void"))) == 0)) {
        /* pass */
        ({ TrStr _sbt_t2884 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _tr_strz(call_expr))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(frees)); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2884); _tr_str_release(_sbt_t2884); });
    } else {
        /* pass */
        ({ TrStr _sbt_t2885 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" _r = "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(call_expr)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(frees)); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2885); _tr_str_release(_sbt_t2885); });
        /* pass */
        if ((strcmp(_tr_strz(rk), _tr_strz(_tr_str_lit("list"))) == 0)) {
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_list_elem_kind(self, f->ret_ty)), _tr_strz(_tr_str_lit("class"))) == 0)) {
                ...
                /* pass */
                ({ TrStr _sbt_t2886 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        std::vector<")), _tr_strz(ecpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("> _v; _v.reserve((size_t)_n);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2886); _tr_str_release(_sbt_t2886); });
                /* pass */
                ({ TrStr _sbt_t2887 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) _v.push_back(")), _tr_strz(ecpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::_wrap((void*)tr__list_ptr_get(_r, _i)));\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2887); _tr_str_release(_sbt_t2887); });
                /* pass */
                ...
                /* pass */
                ({ TrStr _sbt_t2888 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long _n = tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_len(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2888); _tr_str_release(_sbt_t2888); });
                /* pass */
                ({ TrStr _sbt_t2889 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        std::vector<")), _tr_strz(ecpp))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("> _v; _v.reserve((size_t)_n);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2889); _tr_str_release(_sbt_t2889); });
                /* pass */
                if ((strcmp(_tr_strz((*((AstType**)List_ptr_get(f->ret_ty->args, 0LL)))->name), _tr_strz(_tr_str_lit("str"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t2890 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) { TrStr _s = tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _i); _v.push_back(std::string(_s.data ? _s.data : \"\")); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2890); _tr_str_release(_sbt_t2890); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t2891 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        for (long long _i = 0; _i < _n; ++_i) _v.push_back(tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _i));\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2891); _tr_str_release(_sbt_t2891); });
                }
                /* pass */
                ({ TrStr _sbt_t2892 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        tr__list_")), _tr_strz(rsfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_r);\n        return _v;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2892); _tr_str_release(_sbt_t2892); });
            ...
            if ((strcmp(_tr_strz(CppExporter__cpp_dict_kkind(self, f->ret_ty)), _tr_strz(_tr_str_lit("i"))) == 0)) {
                /* pass */
                TrStr _strtmp_t2893 = _tr_str_lit("i64");
                _tr_str_release(ksfx);
                ksfx = _strtmp_t2893;
            }
            /* pass */
            ({ TrStr _sbt_t2894 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        void* _ks = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_keys(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2894); _tr_str_release(_sbt_t2894); });
            /* pass */
            ({ TrStr _sbt_t2895 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long _n = tr__list_")), _tr_strz(ksfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_len(_ks);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2895); _tr_str_release(_sbt_t2895); });
            /* pass */
            ({ TrStr _sbt_t2896 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_dict_key_cpp(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        std::map<")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(", "))); _tr_str_release(_cl); _cres; })); TrStr _cr = (CppExporter__cpp_dict_v_cpp(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("> _m;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2896); _tr_str_release(_sbt_t2896); });
            /* pass */
            ...
            if ((strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0)) {
                /* pass */
                ({ TrStr _sbt_t2897 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("            TrStr _vv = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _k); _m[_kk2] = std::string(_vv.data ? _vv.data : \"\");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2897); _tr_str_release(_sbt_t2897); });
            } else {
                /* pass */
                ({ TrStr _sbt_t2898 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("            _m[_kk2] = tr__dict_")), _tr_strz(vt))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_get(_r, _k);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2898); _tr_str_release(_sbt_t2898); });
            }
            /* pass */
            StringBuilder_append(wb, _tr_str_lit("        }\n"));
            /* pass */
            ({ TrStr _sbt_t2899 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        tr__list_")), _tr_strz(ksfx))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_ks); tr__dict_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(vt)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(_r);\n        return _m;\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2899); _tr_str_release(_sbt_t2899); });
            _tr_str_release(vt);
            _tr_str_release(ksfx);
            ...
            while ((ti < f->ret_ty->args->len)) {
                ...
                if ((strcmp(_tr_strz(sk), _tr_strz(_tr_str_lit("str"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t2900 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        TrStr _ts")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = tr__unbox_str("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); std::string "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(ev)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(_ts"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".data ? _ts"))); _tr_str_release(_cl); _cres; })); TrStr _cr = (_tr_str_wrap(_tr_int_to_str((long long)(ti)))); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(".data : \"\");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2900); _tr_str_release(_sbt_t2900); });
                } else if ((strcmp(_tr_strz(sk), _tr_strz(_tr_str_lit("f64"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t2901 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        double ")), _tr_strz(ev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = tr__unbox_f64("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2901); _tr_str_release(_sbt_t2901); });
                } else {
                    /* pass */
                    ({ TrStr _sbt_t2902 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        long long ")), _tr_strz(ev))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" = (long long)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(slot)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(";\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2902); _tr_str_release(_sbt_t2902); });
                }
                /* pass */
                if ((ti > 0LL)) {
                    /* pass */
                    TrStr _strtmp_t2903 = _tr_strx_concat(_tr_strz(parts), _tr_strz(_tr_str_lit(", ")));
                    _tr_str_release(parts);
                    parts = _strtmp_t2903;
                }
                /* pass */
                TrStr _strtmp_t2904 = _tr_strx_concat(_tr_strz(parts), _tr_strz(ev));
                _tr_str_release(parts);
                parts = _strtmp_t2904;
                /* pass */
                ti = (ti + 1LL);
            ...
            /* pass */
            ({ TrStr _sbt_t2905 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        return std::make_tuple(")), _tr_strz(parts))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(");\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2905); _tr_str_release(_sbt_t2905); });
            _tr_str_release(parts);
            ...
            /* pass */
            ({ TrStr _sbt_t2906 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        return ")), _tr_strz(f->ret_ty->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::_wrap(_r);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2906); _tr_str_release(_sbt_t2906); });
        } else {
            /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_class_decl(CppExporter* self, HirClass* c) {
    ...
    if ((iidx >= 0LL)) {
        ...
        /* pass */
        ({ TrStr _sbt_t2915 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("        explicit ")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2915); _tr_str_release(_sbt_t2915); });
        /* pass */
        ...
        while ((pi < im->params->len)) {
            ...
            if ((emitted > 0LL)) {
                ...
                StringBuilder_append(wb, _tr_str_lit(", "));
                /* pass */
                TrStr _strtmp_t2916 = _tr_strx_concat(_tr_strz(cargs), _tr_strz(_tr_str_lit(", ")));
                _tr_str_release(cargs);
                cargs = _strtmp_t2916;
            }
            /* pass */
            ({ TrStr _sbt_t2917 = (CppExporter__cpp_param_decl(self, p->ty, p->name)); StringBuilder_append(wb, _sbt_t2917); _tr_str_release(_sbt_t2917); });
            /* pass */
            TrStr _strtmp_t2918 = ({ TrStr _cr = (CppExporter__cpp_call_arg(self, p->ty, p->name)); TrStr _cres = _tr_strx_concat(_tr_strz(cargs), _cr.data); _tr_str_release(_cr); _cres; });
            _tr_str_release(cargs);
            cargs = _strtmp_t2918;
            /* pass */
            emitted = (emitted + 1LL);
        ...
        /* pass */
        ({ TrStr _sbt_t2919 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("): h_(tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(cargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")) {}\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2919); _tr_str_release(_sbt_t2919); });
        _tr_str_release(cargs);
    }
    /* pass */
    long long mi = 0LL;
    ...
    while ((mi < c->methods->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t2920 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_type(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("        ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2920); _tr_str_release(_sbt_t2920); });
        /* pass */
        ...
        while ((pj < m->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2921 = (CppExporter__cpp_param_decl(self, mp->ty, mp->name)); StringBuilder_append(wb, _sbt_t2921); _tr_str_release(_sbt_t2921); });
            /* pass */
            TrStr _strtmp_t2922 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(margs), _tr_strz(_tr_str_lit(", ")))); TrStr _cr = (CppExporter__cpp_call_arg(self, mp->ty, mp->name)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
        ...
        /* pass */
        ({ TrStr _at_t2923 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(margs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(")"))); _tr_str_release(_cl); _cres; })); TrStr _sbt_t2924 = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_ret_stmt(self, m->ret_ty, _at_t2923)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(") { ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(wb, _sbt_t2924); _tr_str_release(_at_t2923); _tr_str_release(_sbt_t2924); });
        _tr_str_release(margs);
    }
    /* pass */
    StringBuilder_append(wb, _tr_str_lit("    };\n"));
...
__attribute__((hot)) TrStr CppExporter_generate_cpp_class_bridges(CppExporter* self, HirProgram* prog) {
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            TrStr C = c->name;
            /* pass */
            ({ TrStr _sbt_t2925 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_retain(void* p){ return _tr_obj_retain(p); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2925); _tr_str_release(_sbt_t2925); });
            /* pass */
            ({ TrStr _sbt_t2926 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_release(void* p){ _tr_obj_release(p, _trdrop_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2926); _tr_str_release(_sbt_t2926); });
            /* pass */
            long long iidx = CppExporter__cpp_init_idx(self, c);
            /* pass */
            if ((iidx >= 0LL)) {
                ...
                HirFunction* im = ((HirFunction*)List_ptr_get(c->methods, iidx));
                /* pass */
                ({ TrStr _sbt_t2927 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2927); _tr_str_release(_sbt_t2927); });
                /* pass */
                long long ip = 0LL;
                /* pass */
                long long ie = 0LL;
                ...
                while ((ip < im->params->len)) {
                    ...
                    if ((ie > 0LL)) {
                        ...
                        StringBuilder_append(b, _tr_str_lit(", "));
                        /* pass */
                        TrStr _strtmp_t2928 = _tr_strx_concat(_tr_strz(iargs), _tr_strz(_tr_str_lit(", ")));
                        _tr_str_release(iargs);
                        iargs = _strtmp_t2928;
                    }
                    /* pass */
                    ({ TrStr _sbt_t2929 = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, p->ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(p->name)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2929); _tr_str_release(_sbt_t2929); });
                    /* pass */
                    TrStr _strtmp_t2930 = _tr_strx_concat(_tr_strz(iargs), _tr_strz(p->name));
                    _tr_str_release(iargs);
                    iargs = _strtmp_t2930;
                    /* pass */
                    ie = (ie + 1LL);
            ...
            while ((mi < c->methods->len)) {
                ...
                /* pass */
                ({ TrStr _sbt_t2932 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(void* s"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2932); _tr_str_release(_sbt_t2932); });
                /* pass */
                ...
                while ((pj < m->params->len)) {
                    ...
                    /* pass */
                    ({ TrStr _sbt_t2933 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, mp->ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(", ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(mp->name)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2933); _tr_str_release(_sbt_t2933); });
                    /* pass */
                    TrStr _strtmp_t2934 = ({ TrStr _cl = (_tr_strx_concat(_tr_strz(margs), _tr_strz(_tr_str_lit(", ")))); TrStr _cr = (CppExporter__cpp_c_arg(self, mp->ty, mp->name)); TrStr _cres = _tr_strx_concat(_cl.data, _cr.data); _tr_str_release(_cl); _tr_str_release(_cr); _cres; });
                    _tr_str_release(margs);
                    margs = _strtmp_t2934;
                }
                /* pass */
                ...
                if ((strcmp(_tr_strz(CppExporter__cpp_ty_kind(self, m->ret_ty)), _tr_strz(_tr_str_lit("void"))) == 0)) {
                    /* pass */
                    ({ TrStr _sbt_t2935 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(C), _tr_strz(_tr_str_lit("_")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(margs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2935); _tr_str_release(_sbt_t2935); });
                } else {
                    /* pass */
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->functions)))))) {
        ...
        while ((fi < prog->functions->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2937 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT ")), _cr.data); _tr_str_release(_cr); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2937); _tr_str_release(_sbt_t2937); });
            /* pass */
            ...
            while ((pi2 < f->params->len)) {
                ...
                if ((pi2 > 0LL)) {
                    ...
                    StringBuilder_append(b, _tr_str_lit(", "));
                    /* pass */
                    TrStr _strtmp_t2938 = _tr_strx_concat(_tr_strz(fargs), _tr_strz(_tr_str_lit(", ")));
                    _tr_str_release(fargs);
                    fargs = _strtmp_t2938;
                }
                /* pass */
                ({ TrStr _sbt_t2939 = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, p->ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(pn)); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2939); _tr_str_release(_sbt_t2939); });
                /* pass */
                TrStr _strtmp_t2940 = ({ TrStr _cr = (CppExporter__cpp_c_arg(self, p->ty, pn)); TrStr _cres = _tr_strx_concat(_tr_strz(fargs), _cr.data); _tr_str_release(_cr); _cres; });
                _tr_str_release(fargs);
                fargs = _strtmp_t2940;
                /* pass */
                pi2 = (pi2 + 1LL);
            ...
            if ((strcmp(_tr_strz(frk), _tr_strz(_tr_str_lit("void"))) == 0)) {
                /* pass */
                ({ TrStr _sbt_t2941 = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(f->name), _tr_strz(_tr_str_lit("(")))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2941); _tr_str_release(_sbt_t2941); });
                ...
                /* pass */
                ({ TrStr _sbt_t2942 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return (void*)")), _tr_strz(f->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2942); _tr_str_release(_sbt_t2942); });
            } else {
                /* pass */
                ({ TrStr _sbt_t2943 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("return ")), _tr_strz(f->name))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(fargs)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("); }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2943); _tr_str_release(_sbt_t2943); });
            }
            _tr_str_release(fargs);
            _tr_str_release(frk);
        }
    ...
    /* pass */
    ({ TrStr _sbt_t2944 = (CppExporter__cpp_list_bridges(self)); StringBuilder_append(b, _sbt_t2944); _tr_str_release(_sbt_t2944); });
    /* pass */
    StringBuilder_append(b, _tr_str_lit("#ifdef __cplusplus\n}\n#endif\n"));
    /* pass */
...
__attribute__((hot)) TrStr CppExporter__cpp_list_bridges(CppExporter* self) {
    ...
    while ((di < dk->len)) {
        ...
        if ((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("s"))) == 0)) {
            /* pass */
            TrStr _strtmp_t2950 = _tr_str_lit("TrStr");
            _tr_str_release(kc);
            kc = _strtmp_t2950;
            /* pass */
            TrStr _strtmp_t2951 = _tr_str_lit("_tr_dict_new(8)");
            _tr_str_release(newfn);
            newfn = _strtmp_t2951;
            /* pass */
            TrStr _strtmp_t2952 = _tr_str_lit("_tr_dict_keys((TrMap*)d)");
            _tr_str_release(keysfn);
            keysfn = _strtmp_t2952;
            /* pass */
            TrStr _strtmp_t2953 = _tr_str_lit("_tr_dict_get((TrMap*)d, _tr_strz(k))");
            _tr_str_release(getraw);
            getraw = _strtmp_t2953;
            /* pass */
            TrStr _strtmp_t2954 = _tr_str_lit("_tr_dict_set((TrMap*)d, _tr_strz(k), ");
            _tr_str_release(setpre);
            setpre = _strtmp_t2954;
        }
        /* pass */
        ({ TrStr _sbt_t2955 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new(void){ return (void*)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(newfn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2955); _tr_str_release(_sbt_t2955); });
        /* pass */
        ({ TrStr _sbt_t2956 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void* tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_keys(void* d){ return (void*)"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(keysfn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2956); _tr_str_release(_sbt_t2956); });
        /* pass */
        ...
        if (((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("s"))) == 0) && (strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0))) {
            /* pass */
            TrStr _strtmp_t2965 = _tr_str_lit("Dict_free_strval((Dict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t2965;
        } else if (((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("i"))) == 0) && (strcmp(_tr_strz(vk), _tr_strz(_tr_str_lit("str"))) == 0))) {
            /* pass */
            TrStr _strtmp_t2966 = _tr_str_lit("_tr_idict_free_strval((TrIDict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t2966;
        } else if ((strcmp(_tr_strz(kk), _tr_strz(_tr_str_lit("i"))) == 0)) {
            /* pass */
            TrStr _strtmp_t2967 = _tr_str_lit("_tr_idict_free((TrIDict*)d)");
            _tr_str_release(freefn);
            freefn = _strtmp_t2967;
        }
        /* pass */
        ({ TrStr _sbt_t2968 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("TR_EXPORT void tr__dict_")), _tr_strz(V))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_free(void* d){ "))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(freefn)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("; }\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2968); _tr_str_release(_sbt_t2968); });
        _tr_str_release(V);
        _tr_str_release(kk);
        _tr_str_release(vk);
        _tr_str_release(kc);
...
__attribute__((hot)) TrStr CppExporter_generate_export_cpp_header(CppExporter* self, HirProgram* prog, TrStr ns) {
    ...
    /* pass */
    ({ TrStr _sbt_t2969 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("   link the Tauraro library, and use the `")), _tr_strz(ns))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("::` wrappers. */\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t2969); _tr_str_release(_sbt_t2969); });
    /* pass */
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2974 = (CppExporter__cpp_class_bridge_protos(self, c)); StringBuilder_append(sb, _sbt_t2974); _tr_str_release(_sbt_t2974); });
        }
    }
    /* pass */
    long long i = 0LL;
        ...
        while ((i < prog->functions->len)) {
            ...
            if ((!_is_invalid_ptr(((unsigned long long)(f))))) {
                ...
                if (((f->is_export && (!f->is_extern)) && CppExporter__cpp_export_fn_ok(self, f))) {
                    ...
                    if (CppExporter__cpp_fn_needs_bridge(self, f)) {
                        /* pass */
                        ({ TrStr _sbt_t2975 = (CppExporter__cpp_free_fn_bridge_proto(self, f)); StringBuilder_append(sb, _sbt_t2975); _tr_str_release(_sbt_t2975); });
                    } else {
                        /* pass */
                        ...
                        if (_tr_str_starts_with(_tr_strz(sig), _tr_strz(_tr_str_lit("TR_EXPORT ")))) {
                            /* pass */
                            TrStr _strtmp_t2976 = _tr_str_wrap(_tr_str_slice(_tr_strz(sig), 10LL, _tr_strlen(_tr_strz(sig))));
                            _tr_str_release(sig);
                            sig = _strtmp_t2976;
                        }
                        /* pass */
                        ({ TrStr _sbt_t2977 = (_tr_strx_concat(_tr_strz(sig), _tr_strz(_tr_str_lit(";\n")))); StringBuilder_append(sb, _sbt_t2977); _tr_str_release(_sbt_t2977); });
                        _tr_str_release(sig);
                    }
                }
            }
    ...
    StringBuilder_append(sb, _tr_str_lit("}\n\n"));
    /* pass */
    ({ TrStr _sbt_t2978 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("namespace ")), _tr_strz(ns))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" {\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t2978); _tr_str_release(_sbt_t2978); });
    /* pass */
    ci = 0LL;
    /* pass */
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->classes)))))) {
        ...
        while ((ci < prog->classes->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2979 = (CppExporter__cpp_class_decl(self, c)); StringBuilder_append(sb, _sbt_t2979); _tr_str_release(_sbt_t2979); });
        }
    }
    /* pass */
    i = 0LL;
    ...
    if (((!_is_invalid_ptr(((unsigned long long)(prog)))) && (!_is_invalid_ptr(((unsigned long long)(prog->functions)))))) {
        ...
        while ((i < prog->functions->len)) {
            ...
            if ((!_is_invalid_ptr(((unsigned long long)(f))))) {
                ...
                if (((f->is_export && (!f->is_extern)) && CppExporter__cpp_export_fn_ok(self, f))) {
                    /* pass */
                    ({ TrStr _sbt_t2980 = (CppExporter__cpp_wrap_fn(self, f)); StringBuilder_append(sb, _sbt_t2980); _tr_str_release(_sbt_t2980); });
                }
            }
            /* pass */
            i = (i + 1LL);
    ...
    /* pass */
    ({ TrStr _sbt_t2981 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("}  // namespace ")), _tr_strz(ns))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("\n\n#endif\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(sb, _sbt_t2981); _tr_str_release(_sbt_t2981); });
    /* pass */
    List_TrStr_free(lk);
    List_TrStr_free(dkk);
...
__attribute__((hot)) TrStr CppExporter__cpp_class_bridge_protos(CppExporter* self, HirClass* c) {
    ...
    /* pass */
    ({ TrStr _sbt_t2982 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_retain(void*); void tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_release(void*);\n"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2982); _tr_str_release(_sbt_t2982); });
    /* pass */
    long long iidx = CppExporter__cpp_init_idx(self, c);
    /* pass */
    if ((iidx >= 0LL)) {
        ...
        HirFunction* im = ((HirFunction*)List_ptr_get(c->methods, iidx));
        /* pass */
        ({ TrStr _sbt_t2983 = (({ TrStr _cl = (_tr_strx_concat(_tr_strz(_tr_str_lit("void* tr__")), _tr_strz(C))); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_new("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2983); _tr_str_release(_sbt_t2983); });
        /* pass */
        long long ip = 0LL;
        /* pass */
        long long ie = 0LL;
        ...
        while ((ip < im->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2984 = (CppExporter__cpp_c_ty(self, p->ty)); StringBuilder_append(b, _sbt_t2984); _tr_str_release(_sbt_t2984); });
            /* pass */
            ie = (ie + 1LL);
        }
        /* pass */
    ...
    while ((mi < c->methods->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t2985 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, m->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(C)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("_"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(m->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("(void*"))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2985); _tr_str_release(_sbt_t2985); });
        /* pass */
        long long pj = 0LL;
        /* pass */
        while ((pj < m->params->len)) {
            ...
            /* pass */
            ({ TrStr _sbt_t2986 = (({ TrStr _cr = (CppExporter__cpp_c_ty(self, mp->ty)); TrStr _cres = _tr_strx_concat(_tr_strz(_tr_str_lit(", ")), _cr.data); _tr_str_release(_cr); _cres; })); StringBuilder_append(b, _sbt_t2986); _tr_str_release(_sbt_t2986); });
        }
        /* pass */
        StringBuilder_append(b, _tr_str_lit(");\n"));
    }
...
__attribute__((hot)) TrStr CppExporter__cpp_free_fn_bridge_proto(CppExporter* self, HirFunction* f) {
    ...
    /* pass */
    ({ TrStr _sbt_t2987 = (({ TrStr _cl = (({ TrStr _cl = (({ TrStr _cl = (CppExporter__cpp_c_ty(self, f->ret_ty)); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit(" tr__"))); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(f->name)); _tr_str_release(_cl); _cres; })); TrStr _cres = _tr_strx_concat(_cl.data, _tr_strz(_tr_str_lit("("))); _tr_str_release(_cl); _cres; })); StringBuilder_append(b, _sbt_t2987); _tr_str_release(_sbt_t2987); });
    /* pass */
    long long pi = 0LL;
    /* pass */
    long long e = 0LL;
    ...
    while ((pi < f->params->len)) {
        ...
        /* pass */
        ({ TrStr _sbt_t2988 = (CppExporter__cpp_c_ty(self, ((HirParam*)List_ptr_get(f->params, pi))->ty)); StringBuilder_append(b, _sbt_t2988); _tr_str_release(_sbt_t2988); });
        /* pass */
        e = (e + 1LL);
        /* pass */
        pi = (pi + 1LL);
